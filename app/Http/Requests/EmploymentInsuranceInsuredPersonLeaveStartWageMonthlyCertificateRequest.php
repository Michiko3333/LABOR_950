...
class EmploymentInsuranceInsuredPersonLeaveStartWageMonthlyCertificateRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if(!empty($data['leave_start_date_month']) && !empty($data['leave_start_date_day'])){
                if (!checkdate($data['leave_start_date_month'], $data['leave_start_date_day'], '2000')) {
                    $validator->errors()->add('leave_start_date_day','2枚目_7_休業等を開始した日は正しい日付を入力してください。');
                }
            }
    ...
    public function messages()
    {
        return [
            ...
            'leave_start_date_month.required_with' => '2枚目_7_休業等を開始した日_月を入力してください。',
            'leave_start_date_day.required_with' => '2枚目_7_休業等を開始した日_日を入力してください。',
            ...
            'payment_duration_start_day1_16.required_with' => '2枚目_9_賃金支払対象期間_開始日_16行目を入力してください。',
            ...
            'payment_period_end_day1_16.required_with' => '2枚目_9_賃金支払対象期間_終了日_16行目を入力してください。',
