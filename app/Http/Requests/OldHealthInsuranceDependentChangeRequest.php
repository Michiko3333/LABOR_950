...
class OldHealthInsuranceDependentChangeRequest extends BaseRequest
{
    ...
    public static function rules(): array
    {
        ...
        return [
            ...
            "other_dependent1_reason_type" => 'nullable|string|in:出生,離職,収入減少,同居,死亡,離婚,就職,収入増加,75歳到達,障害認定,その他',
            ...
            "other_dependent2_reason_type" => 'nullable|string|in:出生,離職,収入減少,同居,死亡,離婚,就職,収入増加,75歳到達,障害認定,その他',
