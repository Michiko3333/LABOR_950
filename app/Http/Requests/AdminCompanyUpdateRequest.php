...
class AdminCompanyUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "br-fax1" => 'nullable|array',
            "br-fax1.*" => 'nullable|string|regex:/^0[0-9]{1,3}$/',
            "br-fax2" => 'nullable|array',
            "br-fax2.*" => 'nullable|string|regex:/^[0-9]{1,4}$/',
            "br-fax3" => 'nullable|array',
            "br-fax3.*" => 'nullable|string|regex:/^[0-9]{3,4}$/',"fax1" => 'array',
