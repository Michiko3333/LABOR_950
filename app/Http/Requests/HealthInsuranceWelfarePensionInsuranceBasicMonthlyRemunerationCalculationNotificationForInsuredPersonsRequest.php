...
class HealthInsuranceWelfarePensionInsuranceBasicMonthlyRemunerationCalculationNotificationForInsuredPersonsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "business_establishment_code_prefecture_code" => 'required|string|regex:/^[0-9]{1,2}+$/',
            "office_arrangement_code_county_city_ward_code" => 'required|string|regex:/^[0-9]{1,2}+$/',
            "office_reference_symbol_office_symbol" => 'required|string|regex:/^[ァ-ヴーA-Z0-9]{1,4}+\z/u',
            ...
            "previous_revision_year" => 'nullable|int|between:1,99|regex:/^[0-9]{1,2}+$/',
    ...
    public function attributes()
    {
        return [
            ...
            'business_establishment_code_prefecture_code' => '事業所整理記号_都道府県コード',
            'office_arrangement_code_county_city_ward_code' => '事業所整理記号_郡市区符号',
            'office_reference_symbol_office_symbol' => '事業所整理記号_事業所記号',
