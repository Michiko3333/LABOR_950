...
class ContinuousEmploymentBenefitsForOlderWorkersRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            "input_file_other" => 'nullable|required_if:radio_file_other,2|string|max:255',
            'labor_consultant_acting_as_agent' => 'nullable|string|max:30',
            ...
            'wages_paid1' => 'int|between:0,9999999|regex:/^[0-9]{1,7}$/u',
            'wage_reduction_days1' => 'int|between:0,99|regex:/^[0-9]{1,2}$/u',
