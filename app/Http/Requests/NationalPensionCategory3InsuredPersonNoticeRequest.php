...
class NationalPensionCategory3InsuredPersonNoticeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
			...
			"npc3ipn_1_dependent_tell_area_code" => 'nullable|string|max_digits:5|regex:/^[0-9]+$/u',
			"npc3ipn_1_dependent_tell_city_code" => 'nullable|string|max_digits:4|regex:/^[0-9]+$/u',
			"npc3ipn_1_dependent_tell_subscriber_code" => 'nullable|string|max_digits:5|regex:/^[0-9]+$/u',
