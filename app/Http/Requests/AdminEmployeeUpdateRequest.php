...
class AdminEmployeeUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'address_city' => 'required|string|max:255|max:255|regex:/\A[ぁ-んァ-ン一-龥]+\z/u',
            ...
            'emergency_address_city1' => 'nullable|string|max:255|regex:/\A[ぁ-んァ-ン一-龥]+\z/u',
            ...
            'emergency_address_city2' => 'nullable|string|max:255|max:255|regex:/\A[ぁ-んァ-ン一-龥]+\z/u',
