...
class WageMonthlyCertificateOnEmploymentInsuranceInsuredLeaveStartRequest extends FormRequest
{
    ...
    public static function rules(): array
    {
        return [
            ...
            'employment_insured_no_4_2' => 'nullable|string|regex:/^[0-9]{4}$/u',
            'employment_insured_no_6_2' => 'nullable|string|regex:/^[0-9]{6}$/u',
            'employment_insured_no_cd_2' => 'nullable|string|regex:/^[0-9]{1}$/u',
            'insurance_office_no_4_2' => 'nullable|string|regex:/^[0-9]{4}$/u',
            'insurance_office_no_6_2' => 'nullable|string|regex:/^[0-9]{6}$/u',
            'insurance_office_no_cd_2' => 'nullable|string|regex:/^[0-9]{1}$/u',
            'employment_fullname_2' => 'nullable|string|max:255|regex:/^[ぁ-んァ-ヴー一-龥]+[　][ぁ-んァ-ヴー一-龥]+\z/u',
            'employment_fullname_kana_2' => 'nullable|string|max:255|regex:/^[ァ-ヴー]+[　][ァ-ヴー]+\z/u',
            'caregiver_leave_start_date_year_japan_era_2' => 'nullable|string|max:2',
            'caregiver_leave_start_date_year_2' => 'nullable|int|between:1,99|regex:/^[0-9]{1,2}$/u',
            'caregiver_leave_start_date_month_2' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u',
            'caregiver_leave_start_date_day_2' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u',
            'branch_name' => 'nullable|string|max:255|regex:/^[ぁ-んァ-ヴ０-９ー一-龥　]+\z/u',
            'branch_address_2' => 'nullable|string|max:255|regex:/^[ぁ-んァ-ヴ０-９ー一-龥　]+\z/u',
            ...
            'entrepreneur_name_2' => 'nullable|string|max:255',
            'caregiver_leave_start_date_year_2' => 'nullable|int|between:1,99|regex:/^[0-9]{1,2}$/u',
            'caregiver_leave_start_date_month_2' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u',
            'caregiver_leave_start_date_day_2' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u',
            'leave_start_date_month' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u',
            'leave_start_date_day' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u',
    ...
    public function attributes()
    {
        return [
            ...
            'employment_insured_no_4_2' => '被保険者番号4桁_2枚目',
            'employment_insured_no_6_2' => '被保険者番号6桁_2枚目',
            'employment_insured_no_cd_2' => '被保険者番号1桁_2枚目',
            'insurance_office_no_4_2' => '事業所番号4桁_2枚目',
            'insurance_office_no_6_2' => '事業所番号6桁_2枚目',
            'insurance_office_no_cd_2' => '事業所番号1桁_2枚目',
            'employment_fullname_2' => '休業等を開始した者の氏名_2枚目',
            'employment_fullname_kana_2' => 'フリガナ_2枚目',
            'caregiver_leave_start_date_year_japan_era_2' => '休業等を開始した日の年月日/年号_2枚目',
            'caregiver_leave_start_date_year_2' => '休業等を開始した日の年月日/年_2枚目',
            'caregiver_leave_start_date_month_2' => '休業等を開始した日の年月日/月_2枚目',
            'caregiver_leave_start_date_day_2' => '休業等を開始した日の年月日/日_2枚目',
            'branch_name' => '事業所名称_2枚目',
            'branch_address_2' => '事業所所在地_2枚目',
            ...
            'entrepreneur_name_2' => '事業主氏名_2枚目',
            'caregiver_leave_start_date_year_2' => '介護休業開始年月日/年',
            'caregiver_leave_start_date_month_2' => '介護休業開始年月日/月',
            'caregiver_leave_start_date_day_2' => '介護休業開始年月日/日',
            ...
            'creation_date_submission_agent_2' => '社会保険労務士記載欄_2枚目/作成年月日･提出代行者･事務代理者の表示',
            'labor_consultant_fullname_2' => '社会保険労務士記載欄_2枚目/氏名',
