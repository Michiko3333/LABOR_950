...
class EmploymentInsuredRetirementCertificateRequest extends BaseRequest
{
    ...
    public static function rules(): array
    {
        ...
        return [
            ...
            "branch_address" => ['required', 'string', 'max:40', new FullwidthAndMiscellaneousChars(true)],
            ...
            "company_name" => ['required', 'string', 'max:27', new FullwidthAndMiscellaneousChars(false)],
            "headquarters_address" => ['required', 'string', 'max:40', new FullwidthAndMiscellaneousChars(true)],
            "employer_managerial_position_name" => ['required', 'string', 'max:27', new FullwidthAndMiscellaneousChars(false)],
            ...
            "labor_consultant_acting_as_agent_name" => 'nullable|string|max:12|regex:/\A[ぁ-んァ-ヴー一-龥々０-９Ａ-Ｚ　]+\z/u',
