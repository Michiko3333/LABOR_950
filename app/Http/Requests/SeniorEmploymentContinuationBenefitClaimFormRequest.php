...
class SeniorEmploymentContinuationBenefitClaimFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'employer_name' => 'nullable|string|max:255|regex:/^[ぁ-んァ-ヴー一-龥ａ-ｚＡ-Ｚ]+$/u',
    ...
    {
        return [
            'labor_consultant_acting_as_agent' => '社会保険労務士記載欄/作成年月日・提出代行者・事務代理者',
            ...
            'fullname' => '被保険者氏名',
            'payer_japan_era_year1' => '支給対象年月_1/年',
            'payer_month1' => '支給対象年月_1/月',
            'wages_paid1' => '支給対象年月に支払われた賃金額_1',
            'wage_reduction_days1' => '賃金の減額のあった日_1',
            'payer_japan_era_year2' => '支給対象年月_2/年',
            'payer_month2' => '支給対象年月_2/月',
            'wages_paid2' => '支給対象年月に支払われた賃金額_2',
            'wage_reduction_days2' => '賃金の減額のあった日_2',
            'payer_japan_era_year3' => '支給対象年月_3/年',
            'payer_month3' => '支給対象年月_3/月',
            ...
            'today_japan_era_month' => '証明・申請欄/年月日/月',
            'today_japan_era_day' => '証明・申請欄/年月日/日',
            ...
            'wage_structure_other' => '備考欄/賃金形態_その他記載欄',
            'wage_structure' => '備考欄/賃金形態',
            'prescribed_working_days1' => '備考欄/所定労働日数_1',
            'prescribed_working_days2' => '備考欄/所定労働日数_2',
            'prescribed_working_days3' => '備考欄/所定労働日数_3',
            'commuting_allowance' => '備考欄/通勤手当の有無',
            ...
            'payer_japan_era1' => '支給対象年月_1/年号',
            'payer_japan_era2' => '支給対象年月_2/年号',
            'payer_japan_era3' => '支給対象年月_3/年号',
