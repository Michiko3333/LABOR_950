...
class OldHealthInsuranceDependentChangeWithCertificateRequest extends BaseRequest
{
    /**
    ...
    {
        $rules = new OldHealthInsuranceDependentChangeRequest;
    ...
    public function withValidator($validator): void
    {
        ...
        $validator_1 = new OldHealthInsuranceDependentChangeRequest;
    ...
    {
        $messages = new OldHealthInsuranceDependentChangeRequest;
    ...
    {
        $attributes = new OldHealthInsuranceDependentChangeRequest;
