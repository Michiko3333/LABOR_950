...
class EmploymentInsuranceChildcareLeaveApplicationRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'birth_date_japan_era_year' => 'nullable|int|between:1,99|regex:/^[0-9]{1,2}$/u|required_with:birth_date_month,birth_date_day',
            'birth_date_month' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u|required_with:birth_date_japan_era_year,birth_date_day',
            'birth_date_day' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u|required_with:birth_date_month,birth_date_japan_era_year',
            ...
            'payer_end_month2' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u|required_with:payer_japan_era_year2,payer_month2,payer_day2,payer_day_end2',
            'payer_end_day2' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u|required_with:payer_japan_era_year2,payer_month2,payer_day2,payer_month_end2',
            ...
            'last_payer_japan_era_year' => 'nullable|int|between:1,99|regex:/^[0-9]{1,2}$/u|required_with:last_payer_month,last_payer_japan_day,last_payer_end_month,last_payer_end_day',
            'last_payer_month' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u|required_with:last_payer_japan_era_year,last_payer_japan_day,last_payer_end_month,last_payer_end_day',
            'last_payer_japan_day' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u|required_with:last_payer_month,last_payer_japan_era_year,last_payer_end_month,last_payer_end_day',
            'last_payer_end_month' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u|required_with:last_payer_month,last_payer_japan_day,last_payer_japan_era_year,last_payer_end_day',
            'last_payer_end_day' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u|required_with:last_payer_month,last_payer_japan_day,last_payer_end_month,last_payer_japan_era_year',
            ...
            'return_from_resignation_japan_era_year' => 'nullable|int|between:1,99|regex:/^[0-9]{1,2}$/u|required_with:return_from_resignation_month,return_from_resignation_day',
            'return_from_resignation_month' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u|required_with:return_from_resignation_japan_era_year,return_from_resignation_day',
            'return_from_resignation_day' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u|required_with:return_from_resignation_japan_era_year,return_from_resignation_month',
            ...
            'payment_period_extension_japan_era_year' => 'nullable|int|between:1,99|regex:/^[0-9]{1,2}$/u|required_with:payment_period_extension_month,payment_period_extension_day,payment_period_extension_end_month,payment_period_extension_end_day',
            'payment_period_extension_month' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u|required_with:payment_period_extension_japan_era_year,payment_period_extension_day,payment_period_extension_end_month,payment_period_extension_end_day',
            'payment_period_extension_day' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u|required_with:payment_period_extension_japan_era_year,payment_period_extension_month,payment_period_extension_end_month,payment_period_extension_end_day',
            'payment_period_extension_end_month' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u|required_with:payment_period_extension_japan_era_year,payment_period_extension_month,payment_period_extension_day,payment_period_extension_end_day',
            'payment_period_extension_end_day' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u|required_with:payment_period_extension_japan_era_year,payment_period_extension_month,payment_period_extension_day,payment_period_extension_end_month',
            ...
            'labor_consultant_acting_as_agent_name' => ['nullable', 'string', 'max:30', new FullwidthAndMiscellaneousChars(true)],
            ...
            'unsettled_japan_era_year' => 'nullable|int|between:1,99|regex:/^[0-9]{1,2}$/u|required_with:unsettled_month,unsettled_day',
            'unsettled_month' => 'nullable|int|between:1,12|regex:/^[0-9]{1,2}$/u|required_with:unsettled_japan_era_year,unsettled_day',
            'unsettled_day' => 'nullable|int|between:1,31|regex:/^[0-9]{1,2}$/u|required_with:unsettled_month,unsettled_japan_era_year',
    ...
    public function messages()
    {
        return [
            ...
            'payer_end_month2.required_with' => '支給単位期間その２（末日）_月を入力してください。',
            'payer_end_day2.required_with' => '支給単位期間その２（末日）_日を入力してください。',
            'last_payer_japan_era_year.required_with' => '最終支給単位期間（初日）初日_年を入力してください。',
            'last_payer_month.required_with' => '最終支給単位期間（初日）初日_月を入力してください。',
            'last_payer_japan_day.required_with' => '最終支給単位期間（初日）初日_日を入力してください。',
            'last_payer_end_month.required_with' => '最終支給単位期間（末日）_月を入力してください。',
            'last_payer_end_day.required_with' => '最終支給単位期間（末日）_日を入力してください。',
            'return_from_resignation_japan_era_year.required_with' => '職場復帰年月日_年を入力してください。',
            'return_from_resignation_month.required_with' => '職場復帰年月日_月を入力してください。',
            'return_from_resignation_day.required_with' => '職場復帰年月日_日を入力してください。',
            ...
            'payment_period_extension_end_month.required_with' => '支給対象となる期間の延長事由－期間_終了日付_月を入力してください。',
            'payment_period_extension_end_day.required_with' => '支給対象となる期間の延長事由－期間_終了日付_日を入力してください。',
