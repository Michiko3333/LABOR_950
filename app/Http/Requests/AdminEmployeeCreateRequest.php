...
class AdminEmployeeCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'old_first_name' => 'nullable|string|max:255|regex:/^[ぁ-んァ-ヴー一-龥]+$/u',
            ...
            'name_common' => 'nullable|string|max:255|regex:/^[ぁ-んァ-ヴー一-龥]+$/u',
            'name_common_kana' => 'nullable|string|max:255|regex:/\A[ァ-ヴー!@#\$%\^\*()_+\{\}\[\]:;<>,.?~\/\\-=]+\z/u',
            'sex' => 'integer',
            'post_code' => 'required|string|max:7|regex:/\A[0-9]+\z/u',
            'birthday' => 'required|date',
            'address_prefecture' => 'required|integer',
            'address_city' => 'required|string|max:255|regex:/\A[ぁ-んァ-ン一-龥]+\z/u',
            'address_ward' => 'required|string|max:255|regex:/\A[ぁ-んァ-ン一-龥０-９]+\z/u',
            'address_apartment' => 'nullable|string|max:255|regex:/\A[ぁ-んァ-ン一-龥０-９Ａ-Ｚ　‐]+\z/u',
            ...
            'emergency_post_code1' => 'nullable|string|max:7|regex:/\A[0-9]+\z/u',
            ...
            'emergency_address_apartment1' => 'nullable|string|max:255|regex:/\A[ぁ-んァ-ン一-龥０-９Ａ-Ｚ　‐]+\z/u',
            'emergency_contact2' => 'nullable|string|max:255',
            'emergency_relationship2' => 'nullable|string|max:255',
            'emergency_post_code2' => 'nullable|string|max:7|regex:/\A[0-9]+\z/u',
            ...
            'emergency_address_apartment2' => 'nullable|string|max:255|regex:/\A[ぁ-んァ-ン一-龥０-９Ａ-Ｚ　‐]+\z/u',
