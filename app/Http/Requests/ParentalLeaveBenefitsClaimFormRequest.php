...
class ParentalLeaveBenefitsClaimFormRequest extends FormRequest
{
    ...
    public static function rules(): array
    {
        return [
            ...
            'childcare_start_date_japane_era' => 'nullable|string|max:2',
            'childcare_start_date_japane_era_year' => 'nullable|int|max:99|regex:/^[0-9]{1,2}$/u',
            ...
            'employer_company_managerial_position_name1' => 'nullable|string|max:255',
    ...
    public function attributes()
    {
        return [
            ...
            'employer_company_managerial_position_name1' => '事業主名',
