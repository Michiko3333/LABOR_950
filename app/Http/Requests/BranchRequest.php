...
class BranchRequest extends BaseRequest
{
    ...
    public function validationData()
    {
        ...
        foreach ($this->input('sa-applied_date', []) as $branchIndex => $salaryArray) {
            foreach ($salaryArray as $salaryIndex => $salary) {
                if (!isset($data['sa-departments'][$branchIndex][$salaryIndex])){
                    $data['sa-departments'][$branchIndex][$salaryIndex] = [];
                }
            }   
        }
        foreach ($this->input('bo-applied_date', []) as $branchIndex => $array) {
            foreach ($array as $index => $salary) {
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            "br-labor_insurance_no.*" =>  ['nullable', 'string', new NumberOnly(14)],
            "br-labor_insurance_payment_method" => 'array',
            "br-labor_insurance_payment_method.*" => 'nullable|integer',
            "br-insurance_office_no" => 'array',
            "br-insurance_office_no.*" => ['nullable', 'string', new NumberOnly(5)],
            "br-insurance_office_reference_no" => 'array',
            "br-insurance_office_reference_no.*" => ['nullable', 'string', new NumberOnly(5)],
            "br-pension_office_id" => 'array',
            "br-pension_office_id.*" => 'nullable|integer',
            "br-pension_office_no" => 'array',
            "br-pension_office_no.*" => ['nullable', 'string', new NumberOnly(5)],
            "br-pension_office_reference_prefecture" => 'array',
            "br-pension_office_reference_prefecture.*" => ['nullable', 'string', new NumberOnly(2)],
            ...
            "br-labor_bureau_name.*" => 'nullable|string|max:100',
            "br-labor_supervision_name" => 'array',
            "br-labor_supervision_name.*" => 'nullable|string|max:100',
            "br-start_date_of_month" => 'array',
            "br-start_date_of_month.*" => 'nullable|integer|between:1,31',
            ...
            "br-holiday_legal.*" => 'nullable|string|max:255',
            "br-holiday_not_logal" => 'array',
            "br-holiday_not_logal.*" => 'nullable|string|max:255',
            "br-labor_insurance_category" => 'array',
            "br-labor_insurance_category.*" => 'nullable|integer',
            "br-kenpo_no" => 'array',
            "br-kenpo_no.*" => ['nullable', 'string', new NumberOnly(8)],
