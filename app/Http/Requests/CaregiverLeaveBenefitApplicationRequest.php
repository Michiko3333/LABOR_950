...
class CaregiverLeaveBenefitApplicationRequest extends BaseRequest
{
    ...
    public static function rules(): array
    {
        ...
        return [
            ...
            'employment_mynumber_card_no' => 'nullable|string|max:12|regex:/^[0-9]{12}$/u',
            ...
            'dependent_mynumber_card_no' => 'string|max:12|regex:/^[0-9]{12}$/u',
            ...
            'bank_account_no' => 'nullable|string|regex:/^[0-9]{7}$/u',
            'japan_post_bank_code_no' => 'nullable|string|regex:/^[0-9]{3,5}$/u',
            'japan_post_bank_account_no' => 'nullable|string|regex:/^[0-9]{7,8}$/u',
            ...
            'creation_date_submission_agent' => 'nullable|string|max:30',
            'labor_consultant_fullname' => ['nullable', 'string', 'max:27', new FullwidthAndMiscellaneousChars(true)],
