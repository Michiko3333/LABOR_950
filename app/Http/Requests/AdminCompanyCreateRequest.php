...
class AdminCompanyCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'company_type_id' => 'integer|in:1-24',
            'license_no' => 'nullable|string|max:255',
            'business_type' => 'integer|in:1-3',
            'listed_type' => 'nullable|integer|in:1-6',
            ...
            "br-labor_insurance_payment_method.*" => 'nullable|integer|in:1-2',
