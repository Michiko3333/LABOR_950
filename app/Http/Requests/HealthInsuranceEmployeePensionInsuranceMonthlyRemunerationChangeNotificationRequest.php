...
class HealthInsuranceEmployeePensionInsuranceMonthlyRemunerationChangeNotificationRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "before_revision_date_year" => 'int|between:1989,9999|regex:/^[0-9]{1,4}+$/',
            "before_revision_date_month" => 'int|between:1,12|regex:/^[0-9]{1,2}+$/',
            ...
            "salary_calculation_basic_days1" => 'required|int|between:0,31|regex:/^[0-9]{1,2}+$/',
            "salary_calculation_basic_days2" => 'required|int|between:0,31|regex:/^[0-9]{1,2}+$/',
            "salary_calculation_basic_days3" => 'required|int|between:0,31|regex:/^[0-9]{1,2}+$/',
            "monthly_salary_currency1" => 'required|int|between:0,9999999|regex:/^[0-9]{1,7}+$/',
            "monthly_salary_currency2" => 'required|int|between:0,9999999|regex:/^[0-9]{1,7}+$/',
            "monthly_salary_currency3" => 'required|int|between:0,9999999|regex:/^[0-9]{1,7}+$/',
            "monthly_salary_in_kind1" => 'nullable|int|between:0,9999999|regex:/^[0-9]{1,7}+$/',
            "monthly_salary_in_kind2" => 'nullable|int|between:0,9999999|regex:/^[0-9]{1,7}+$/',
            "monthly_salary_in_kind3" => 'nullable|int|between:0,9999999|regex:/^[0-9]{1,7}+$/',
            "monthly_salary_sum1" => 'required|int|between:0,9999999|regex:/^[0-9]{1,7}+$/',
            "monthly_salary_sum2" => 'required|int|between:0,9999999|regex:/^[0-9]{1,7}+$/',
            "monthly_salary_sum3" => 'required|int|between:0,9999999|regex:/^[0-9]{1,7}+$/',
            "sum" => 'required|int|between:0,9999999|regex:/^[0-9]{1,7}+$/',
    ...
    public function withValidator($validator): void
    {
        ...
        $validator->after(function ($validator) {
            ...
            if (isset($data['birthday_year']) && ctype_digit($data['birthday_year'])) {
                if ($birthday_era === '1') {
                    $birthday_year = 1867 + $data['birthday_year'];
                } elseif ($birthday_era === '3') {
                    $birthday_year = 1911 + $data['birthday_year'];
