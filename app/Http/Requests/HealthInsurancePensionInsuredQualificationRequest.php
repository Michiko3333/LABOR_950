...
class HealthInsurancePensionInsuredQualificationRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'branch_address' => ['required', 'string', 'max:50', new FullwidthAndMiscellaneousChars(true)],
            'branch_name' => ['required', 'string', 'max:34', new FullwidthAndMiscellaneousChars(true)],
            'entrepreneur_name' => ['required', 'string', 'max:25', new FullwidthAndMiscellaneousChars(true)],
