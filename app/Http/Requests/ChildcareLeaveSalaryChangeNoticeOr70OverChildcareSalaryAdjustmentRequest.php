...
class ChildcareLeaveSalaryChangeNoticeOr70OverChildcareSalaryAdjustmentRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            "remarks_and_calculation_of_employees_aged_70_and_over" => 'nullable|string|max:1|in:有',
            "remarks_and_two_or_more_jobs" => 'nullable|string|max:1|in:有',
            "remarks_and_part_time_worker" => 'nullable|string|max:1|in:有',
            "remarks_and_part" => 'nullable|string|max:1|in:有',
            "remarks_and_others" => 'nullable|string|max:1|in:有',
            "comment_other" => 'nullable|string|max:10',
            "month_check" => 'nullable|string|max:8|in:開始していません',
