...
use App\Http\Requests\ChildcareLeaveSalaryChangeNoticeOr70OverChildcareSalaryAdjustmentRequest;
...
class ChildcareLeaveSalaryChangeNoticeOr70OverChildcareSalaryAdjustmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('ledger.childcare_leave_salary_change_notice_or70_over_childcare_salary_adjustment', [
            'company' => $company,
    ...
    public function post(ChildcareLeaveSalaryChangeNoticeOr70OverChildcareSalaryAdjustmentRequest $request)
    {
        $attachment = [];
        $data = $request->all();
