class WageList {
    constructor(base_uri, post_uri, filter_showlist_uri, filter_load_uri, filter_save_uri, filter_remove_uri, id) {
    ...
    addColumn(name, section, position) {
        ...
        for (let l = 0; l < wageListHeader.children.length; l++) {
            ...
            custom_th.dataset.key = section + '_values';
    ...
    editColumn(name, key, original) {
        ...
        const th = document.querySelector('th[data-name="' + original + '"][data-key="' + key + '"]');
