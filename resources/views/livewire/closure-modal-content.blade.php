    ...
    <script type="module">
        Livewire.on('client-modal-render', () => {
            setTimeout(() => {
                ...
                initializeCalendar('.closure-calendar.planned-end-date-of-closure', 'plannedEndDateOfClosure');
                initializeCalendar('.closure-calendar.date-of-birth', 'dateOfBirth');
                initializeCalendar('.closure-calendar.date-of-start-of-foster-care', 'dateOfStartOfFosterCare');
                initializeCalendar('.closure-calendar.planned-end-date-of-child-support', 'plannedEndDateOfChildSupport');
