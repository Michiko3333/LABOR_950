<div>
    <h3>標準報酬月額　定時改定表</h3>
    <a class="ui button primary mb-1 button-disable small" type="button" href="javascript:openModal('0',null)">新規入力
    </a>
    <div class="ui form">
        <div style="display: flex; align-items: baseline;">
            <h4 style="margin-right:25px">定時改定年月</h4>
                        ...
                        @if ($this->items)
                            @foreach ($this->items as $item)
                                <tr class="card">
                                    ...
                                    <td>
                                        {{ $item['welfare_annuity_insurance'] }}
                                    </td>
                                    <td class="right aligned collapsing">
                                        <a class="ui basic primary button button-disable" type="button"
                                            onClick="javascript:openModal('0',{{ $item['id'] }})">
                                            編集
                                        </a>
                                    </td>
                                </tr>
