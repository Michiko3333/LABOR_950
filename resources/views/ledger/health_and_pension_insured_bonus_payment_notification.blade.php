    ...
    <section class="content">
        ...
        <script type="module">
            $(document).ready(function() {
                ...
                $('#N17_005F_985A_8F5C_8DCE_82C9').val('{{ old('employer_company_managerial_position_name', ($businessOwner->last_name ? $businessOwner->last_name . '　' : '') . ($businessOwner->first_name ?? '')) }}');
