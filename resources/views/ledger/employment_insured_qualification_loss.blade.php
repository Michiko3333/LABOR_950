    ...
    <section class="content">
        ...
        <script type="module">
            function insertDataFromEmployee(data) {
                ...
                const retirement_reason_contract_period_expired_eternal_hire = data[
                    'retirement_reason_contract_period_expired_eternal_hire'];
                const retirement_reason_contract_period_expired_except_eternal_hire = data[
                    'retirement_reason_contract_period_expired_except_eternal_hire'];
                const retirement_reason_business_owner_suggestion = data['retirement_reason_business_owner_suggestion'];
                const retirement_reason_employee_decision_change_job_type = data[
                    'retirement_reason_employee_decision_change_job_type'];
                ...
                if (branch.employment_insurance_office_no != null && branch.employment_insurance_office_no.length == 11) {
                    ...
                    $('#J9_005F_8E96_8BC6_8F8A_94D4_8D86CD').val(branch.employment_insurance_office_no.substring(10, 11));
                } else {
                ...
                if (employee.country_id !== null) {
                    $('#J47_005F_94ED_95DB_8CAF_8ED2_8E81_96BC_838D_815B_837D_8E9A').val((employee.first_name_alphabet ?
                        employee.first_name_alphabet + ' ' : '') + (employee.last_name_alphabet ?? ''));
                    ...
                    $('#J47_005F_94ED_95DB_8CAF_8ED2_8E81_96BC_838D_815B_837D_8E9A').prop('disabled', false);
                    $('#J86_005F_8DDD_97AF_834A_815B_8368_94D4_8D86').prop('disabled', false);
                    $('#J49_005F_944E').prop('disabled', false);
                    $('#J50_005F_8C8E').prop('disabled', false);
                    $('#J51_005F_93FA').prop('disabled', false);
                    $('#J52_005F_9468_8CAD_005F_90BF_9589_8F41_984A_8BE6_95AA').prop('disabled', false);
                    $('#J53_005F_8D91_90D0_005F_926E_88E6').prop('disabled', false);
                    $('#J54_005F_8DDD_97AF_8E91_8A69').prop('disabled', false);
                ...
                $('#J8_005F_97A3_9045_8ED2_8E81_96BC_005F_8374_838A_834B_8369').val((employee.last_name_kana ? employee
                    .last_name_kana + '　' : '') + (employee.first_name_kana ?? ''));
                $('#J9_005F_97A3_9045_8ED2_8E81_96BC').val((employee.last_name ? employee.last_name + '　' : '') + (employee
                    .first_name ?? ''));
                $('#J12_005F_944').val(employmentRetirementConvertDate['year'] ?? "");
                $('#J13_005F_8C8').val(employmentRetirementConvertDate['month'] ?? "");
                $('#J14_005F_93F').val(employmentRetirementConvertDate['day'] ?? "");
                $('#J15_005F_96BC_8FCC').val(company.name ?? '');
                $('#J16_005F_8F8A_8DDD_926E').val((branch_prefecture_data.name ?? '') + (branch.address_city ?? '') + (branch
                ...
                $('#J22_005F_8F5A_8F8A').val((employee_prefecture_data.name ?? '') + (employee.address_city ?? '') + (employee
                ...
                $('#J63_005F_97A3_9045_8ED2_8F90_96BC').val((employee.last_name ? employee.last_name + '　' : '') + (employee
                    .first_name ?? ''));
                $('#J35_005F_8C8E').val(isNaN(parseInt(retirement_date_nextday_month, 10)) ? '' : parseInt(
                    retirement_date_nextday_month, 10));
                $('#J36_005F_93FA').val(isNaN(parseInt(retirement_date_nextday_day, 10)) ? '' : parseInt(
                    retirement_date_nextday_day, 10));
                $('#J86_005F_9149_91F02').on('change', function() {
                    if ($(this).prop('checked')) {
                        ...
                        if (retirement_reason_age.retirement_reason_type === 'a') {
                            ...
                            $('#J106_005F_8C70_91B1_8CD9_9770_8AF3_965D_8ED2_005F_97A3_9045_979D_9752_005F_82BB_82CC_91BC_005F_8BEF_91CC_9349_979D_9752')
                                .val(retirement_reason_age.retirement_reason ?? '');
                        }
                    }
                });
                $('#J87_005F_9149_91F03_005F1').on('change', function() {
                    if ($(this).prop('checked')) {
                        $('#J194_005F_8CD9_9770_8AFA_8AD4_939E_9788_005F_31_89F1_82CC_8C5F_96F1_8AFA_8AD4').val(
                            retirement_reason_contract_period_reached_limit.contract_period_once ?? '');
                        $('#J195_005F_8CD9_9770_8AFA_8AD4_939E_9788_005F_92CA_8E5A_8C5F_96F1_8AFA_8AD4').val(
                            retirement_reason_contract_period_reached_limit.contract_period_total ?? '');
                        $('#J196_005F_8CD9_9770_8AFA_8AD4_939E_9788_005F_8C5F_96F1_8D58_9056_89F1_9094').val(
                            retirement_reason_contract_period_reached_limit.contract_renewal_count ?? '');
                        if (retirement_reason_contract_period_reached_limit
                            .shortened_contract_renewal_reached_limit_flg === 0) {
                        ...
                        if (retirement_reason_contract_period_reached_limit
                            .rehire_contract_renewal_reached_limit_flg === 0) {
                            $('#J199_005F_Radio2').prop('checked', true);
                        } else {
                            $('#J199_005F_Radio1').prop('checked', true);
                        }
                        if (retirement_reason_contract_period_reached_limit.contract_period_total_reached_limit_flg ===
                            0) {
                        ...
                        if (retirement_reason_contract_period_reached_limit
                            .contract_period_total_established_before_law_amendment_flg === 0) {
                ...
                $('#J107_005F_Radio1').on('change', function() {
                    if ($('#J107_005F_Radio1').prop('checked')) {
                        $('#J108_005F_8FED_9770_984A_93AD_8ED2_005F1_89F1_82CC_8C5F_96F1_8AFA_8AD4').val(
                            retirement_reason_contract_period_expired_eternal_hire.contract_period_once ?? '');
                        $('#J109_005F_8FED_9770_984A_93AD_8ED2_005F_92CA_8E5A_8C5F_96F1_8AFA_8AD4').val(
                            retirement_reason_contract_period_expired_eternal_hire.contract_period_total ?? '');
                        $('#J110_005F_8FED_9770_984A_93AD_8ED2_005F_8C5F_96F1_8D58_9056_89F1_9094').val(
                            retirement_reason_contract_period_expired_eternal_hire.contract_renewal_count ?? '');
                        if (retirement_reason_contract_period_expired_eternal_hire
                            .contract_renewal_guarantee_agreement_flg === 0) {
                        ...
                        if (retirement_reason_contract_period_expired_eternal_hire.employment_termination_notice_flg ===
                            0) {
                            $('#J113_005F_Radio2').prop('checked', true);
                        } else {
                            $('#J113_005F_Radio1').prop('checked', true);
                        }
                        if (retirement_reason_contract_period_expired_eternal_hire.non_renewal_clause_addition_flg ===
                            0) {
                            $('#J202_005F_Radio2').prop('checked', true);
                        } else {
                            $('#J202_005F_Radio1').prop('checked', true);
                        }
                        if (retirement_reason_contract_period_expired_eternal_hire.contract_renewal_request_type ===
                            'a') {
                            $('#J114_005F_Radio2').prop('checked', true);
                        } else if (retirement_reason_contract_period_expired_eternal_hire
                            .contract_renewal_request_type === 'b') {
                            $('#J114_005F_Radio2').prop('checked', true);
                        } else {
                ...
                $('#J107_005F_Radio2').on('change', function() {
                    if ($('#J107_005F_Radio2').prop('checked')) {
                        ...
                        $('#J116_005F_8FED_9770_984A_93AD_8ED2_005F_92CA_8E5A_8C5F_96F1_8AFA_8AD4').val(
                            ...
                            '');
                        $('#J117_005F_8FED_9770_984A_93AD_8ED2_005F_8C5F_96F1_8D58_9056_89F1_9094').val(
                            retirement_reason_contract_period_expired_except_eternal_hire.contract_renewal_count ??
                            '');
                        if (retirement_reason_contract_period_expired_except_eternal_hire
                            .contract_renewal_guarantee_agreement_flg === 0) {
                            $('#J118_005F_Radio2').prop('checked', true);
                        } else {
                            $('#J118_005F_Radio1').prop('checked', true);
                        }
                        if (retirement_reason_contract_period_expired_except_eternal_hire.no_contract_renewal_flg ===
                            0) {
                        ...
                        if (retirement_reason_contract_period_expired_except_eternal_hire
                            .contract_renewal_request_type === 'a') {
                            $('#J120_005F_Radio2').prop('checked', true);
                        } else if (retirement_reason_contract_period_expired_except_eternal_hire
                            .contract_renewal_request_type === 'b') {
                            $('#J120_005F_Radio2').prop('checked', true);
                        } else {
                        ...
                        if (retirement_reason_contract_period_expired_except_eternal_hire
                            .employment_instructions_type === 'a') {
                ...
                $('#J94_005F_9149_91F04_005F3_005F2').on('change', function() {
                    if ($('#J94_005F_9149_91F04_005F3_005F2').prop('checked')) {
                        $('#J122_005F_8AF3_965D_91DE_9045_9694_82CD_91DE_9045_8AA9_8FA7_005F_82BB_82CC_91BC_005F_8BEF_91CC_9349_979D_9752')
                            .val(retirement_reason_business_owner_suggestion.retirement_recommendation_reason ?? '');
                    }
                });
                ...
                $('#J99_005F_9149_91F05_005F1_005F6').on('change', function() {
                    if ($('#J99_005F_9149_91F05_005F1_005F6').prop('checked')) {
                        $('#J124_005F_8E96_8BC6_8F8A_88DA_935D_82C9_82E6_82E8_92CA_8BCE_8DA2_93EF_005F_8F8A_8DDD_926E')
                            .val(retirement_reason_employee_decision_change_office.place ?? '');
                    }
                });
                $('#J100_005F_9149_91F05_005F1_005F7').on('change', function() {
                    if ($('#J100_005F_9149_91F05_005F1_005F7').prop('checked')) {
                        $('#J125_005F_82BB_82CC_91BC_005F_8BEF_91CC_9349_979D_9752').val(
                            retirement_reason_employee_decision_reasons.reason ?? '');
                    }
                });
                $('#J102_005F_9149_91F06').on('change', function() {
                    if ($('#J102_005F_9149_91F06').prop('checked')) {
                        $('#J126_005F_82BB_82CC_91BC_005F_8BEF_91CC_9349_979D_9752').val(retirement_reason_other_reasons
                            .reason ?? '');
                    }
                });
            }
            ...
            $('#J29_005F_94ED_95DB_8CAF_8ED2_8E81_96BC').on('input', function() {
                $('#J8_005F_97A3_9045_8ED2_8E81_96BC_005F_8374_838A_834B_8369').val($(this).val());
            });
            $('#J9_005F_97A3_9045_8ED2_8E81_96BC').on('input', function() {
                $('#J63_005F_97A3_9045_8ED2_8F90_96BC').val($(this).val());
            });
            ...
            $('#J72_005F_8C8E').on('change', function() {
                $('#J74_005F_8C8E').val($(this).val());
            });
            $('#J73_005F_93FA').on('change', function() {
                $('#J75_005F_93FA').val($(this).val());
            });
            $('#J74_005F_92F1_8F6F_91E3_8D73_8ED2_8E96_96B1_91E3_979D_8ED2_82CC_955C_8EA6').on('change', function() {
                $('#J76_005F_92F1_8F6F_91E3_8D73_8ED2_005F_8E96_96B1_91E3_979D_8ED2_82CC_955C_8EA6').val($(this).val());
            });
            $('#J75_005F_8E81_96BC').on('change', function() {
                $('#J77_005F_8E81_96BC').val($(this).val());
            });
            $('#J76_005F_8E73_8A4F_8BC7_94D4').on('change', function() {
                $('#J78_005F_8E73_8A4F_8BC7_94D4').val($(this).val());
            });
            $('#J77_005F_8E73_93E0_8BC7_94D4').on('change', function() {
                $('#J79_005F_8E73_93E0_8BC7_94D4').val($(this).val());
            });
