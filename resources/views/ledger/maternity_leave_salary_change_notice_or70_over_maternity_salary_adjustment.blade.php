        ...
        <script type="module">
            $(document).ready(function() {
                ...
                @if ($current_employee->role_id === 500)
                    ...
                    .prop('readonly', false);
                @else
                    $('#_8ED0_89EF_95DB_8CAF_984A_96B1_8E6D_82CC_92F1_8F6F_91E3_8D73_8ED2_96BC_002E14')
        ...
        <script type="module">
            function insertDataFromEmployee(data) {
                ...
                if (branch.post_code != null) {
                    $('#_8E96_8BC6_8F8A_8F8A_8DDD_926Ex_9758_95D6_94D4_8D86x_9065_94D4_8D86_002E6').val(branch.post_code.substring(0, 3));
                    $('#_8E96_8BC6_8F8A_8F8A_8DDD_926Ex_9758_95D6_94D4_8D86x_8E71_94D4_8D86_002E7').val(branch.post_code.substring(3, 7));
                }
                ...
                $('#_94ED_95DB_8CAF_8ED2_8E81_96BCx_8ABF_8E9A_8E81_96BC_002E18').val((employee.last_name ? employee.last_name + '　' : '') + (employee
                    .first_name ?? ''));
                $('#_94ED_95DB_8CAF_8ED2_8E81_96BCx_834A_8369_8E81_96BC_002E17').val((employee.last_name_kana ? employee
                    .last_name_kana + '　' : '') + (employee.first_name_kana ?? ''));
                $('#J11_005F_90AB_95CA').val((employee.sex === 1) ? '1' : '2');


                $('#_94ED_95DB_8CAF_8ED2_90B6_944E_8C8E_93FAx_8CB3_8D86_002E19').val(birthdayConvertJapan['era'] ?? "");
