            ...
            <form id="ledger-form" action="" method="post">
                ...
                <div class="ledger-twocol my-2">
                    ...
                    <div class="right-col">
                        <div class="ui card card-shadow">
                            <div class="content">
                                <x-form.employment_insured_status_acquisition_not_issued_separation_form :residentials="$residentials" :countries="$countries" :employmentStatuses="$employmentStatuses"/>
                            </div>
                        </div>
                    </div>
                </div>
