<x-layout title="帳票作成：">
    ...
    @endslot
    <h1>健康保険・厚生年金保険被保険者報酬月額算定基礎届（単記用）（２０１９年５月以降手続き）／電子申請</h1>
    ...
    <script type="module">
        function insertDataFromEmployee(data) {
            ...
            $('#N11_005F_94ED_95DB_8CAF_8ED2_8E81').val((headquarters.address_prefecture ?? '') + (headquarters.address_city ?? '') + (headquarters.address_ward ?? '') + (headquarters.address_apartment ?? ''));
