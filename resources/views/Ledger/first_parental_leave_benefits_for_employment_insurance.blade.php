        ...
        <script type="module">
            function insertDataFromEmployee(data) {
                ...
                if ( employee.employment_insurance_office_no !== null && employee.employment_insurance_office_no.length == 11 ) {
                    $('#J23_005F_8E96_8BC6_8F8A_94D4_8D864_8C85').val(employee.employment_insurance_office_no.substring(0, 4));
                    $('#J24_005F_8E96_8BC6_8F8A_94D4_8D866_8C85').val(employee.employment_insurance_office_no.substring(4, 10));
                    $('#J25_005F_8E96_8BC6_8F8A_94D4_8D86CD').val(employee.employment_insurance_office_no.substring(10, 11));
                    $('#J6_005F_8E96_8BC6_8F8A_94D4_8D864_8C85').val(employee.employment_insurance_office_no.substring(0, 4));
                    $('#J7_005F_8E96_8BC6_8F8A_94D4_8D866_8C85').val(employee.employment_insurance_office_no.substring(4, 10));
                    $('#J8_005F_8E96_8BC6_8F8A_94D4_8D86CD').val(employee.employment_insurance_office_no.substring(10, 11));
                }else{
                ...
                $('#J46_005F_94ED_95DB_8CAF_8ED2_82CC_8F5A_8F8A_005F_8ABF_8E9A_005F_8E73_8BE6_8C53_8B79_82D1_92AC_91BA_96BC').val((employee.address_prefecture || "") + (employee.address_city || ""));
                $('#J47_005F_94ED_95DB_8CAF_8ED2_82CC_8F5A_8F8A_005F_8ABF_8E9A_005F_929A_96DA_005F_94D4_926E').val(employee.address_ward || '');
                $('#J48_005F_94ED_95DB_8CAF_8ED2_82CC_8F5A_8F8A_005F_8ABF_8E9A_005F_8341_8370_815B_8367_005F_837D_8393_8356_8387_8393_96BC_9399').val(employee.address_apartment || '');
                $('#J149_005F_8E96_8BC6_8F8A_96BC_005F_8F8A_8DDD_926E').val((headquarters.address_prefecture || "") + (headquarters.address_city || "") + (headquarters.address_ward || "") + (headquarters.address_apartment || ""));
                ...
                $('#J17_005F_8F8A_8DDD_926E').val((branch.address_prefecture || "") + (branch.address_city || "") + (branch.address_ward || "") + (branch.address_apartment || ""));
                ...
                $('#J23_005F_8F5A_8F8A').val((employee.address_prefecture || "") + (employee.address_city || "") + (employee.address_ward || "") + (employee.address_apartment || ""));
            ...
            document.getElementById('J21_005F_94ED_95DB_8CAF_8ED2_8E81_96BC_8374_838A_834B_8369').addEventListener('input', function() {
                document.getElementById('J162_005F_905C_90BF_8ED2_8E81_96BC_005F_8374_838A_834B_8369').value = this.value;
            ...
            document.getElementById('J196_005F_8ED0_89EF_95DB_8CAF_984A_96B1_8E6D_005F_8E81_96BC').addEventListener('input', function() {
            ...
            document.getElementById('J47_005F_94ED_95DB_8CAF_8ED2_82CC_8F5A_8F8A_005F_8ABF_8E9A_005F_929A_96DA_005F_94D4_926E').addEventListener('input', addressPlus);
            document.getElementById('J48_005F_94ED_95DB_8CAF_8ED2_82CC_8F5A_8F8A_005F_8ABF_8E9A_005F_8341_8370_815B_8367_005F_837D_8393_8356_8387_8393_96BC_9399').addEventListener('input', addressPlus);
            function addressPlus() {
                const prefectureCity = document.getElementById('J46_005F_94ED_95DB_8CAF_8ED2_82CC_8F5A_8F8A_005F_8ABF_8E9A_005F_8E73_8BE6_8C53_8B79_82D1_92AC_91BA_96BC').value;
                const addressWard = document.getElementById('J47_005F_94ED_95DB_8CAF_8ED2_82CC_8F5A_8F8A_005F_8ABF_8E9A_005F_929A_96DA_005F_94D4_926E').value;
                const addressApartment = document.getElementById('J48_005F_94ED_95DB_8CAF_8ED2_82CC_8F5A_8F8A_005F_8ABF_8E9A_005F_8341_8370_815B_8367_005F_837D_8393_8356_8387_8393_96BC_9399').value;
