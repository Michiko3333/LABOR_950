<x-layout title="雇用保険被保険者六十歳到達時等賃金証明書の提出及び高年齢雇用継続給付受給資格確認（令和４年６月以降手続き）">
    <section class="content">
        ...
        @endslot
        <h1 class="mt-2"> 雇用保険被保険者六十歳到達時等賃金証明書の提出及び高年齢雇用継続給付受給資格確認（令和４年６月以降手続き）</h1>
        ...
        <script type="module">
            ...
            if ( birthday ){
                ...
                var birthdayYear = parseInt(dateParts[0]);
                var birthdayMonth = parseInt(dateParts[1]);
                var birthdayDay = parseInt(dateParts[2]);
            }else{
                var birthdayYear = "";
                var birthdayMonth = "";
                var birthdayDay = "";
            }
            $('#J26_005F_944E').val(birthdayYear);
            $('#J27_005F_8C8E').val(birthdayMonth);
            $('#J28_005F_93FA').val(birthdayDay);
        }
