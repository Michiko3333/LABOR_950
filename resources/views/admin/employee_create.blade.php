                        ...
                        <div class="three fields">
                            ...
                            <div class="required field {{err($errors, 'employee_status')}}">
                                ...
                                <select class="ui fluid dropdown" name="employee_status">
                                    ...
                                    <option value="{{$k}}" {{ old('employee_status')==$k || (isset($employee) &&
                                        old('employee_status', $employee->employee_status) == $k) ? 'selected' : ''
                                        }}>{{$item}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="three fields">
                            <div class="required field {{err($errors, 'sex')}}">
                                ...
                                <select class="ui fluid dropdown" name="sex" value="{{ old('sex') }}">
                                    ...
                                    <option value="{{ $id }}" {{ old('sex')=="$id" || (isset($employee) && old('sex',
                                        $employee->sex) == "$id") ? 'selected' : '' }}>{{
                                        $name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="required field {{err($errors, 'birthday')}}">
                                ...
                                <div class="ui calendar" id="birthday_date_calendar">
                                    <div class="ui input left icon">
                                        ...
                                        <input type="hidden" name="formatted_birthday_date" id="formatted_birthday_date"
                                            value="{{ old('birthday') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="required field {{err($errors, 'country_id')}}">
                                ...
                                <select class="ui fluid dropdown" name="country_id">
                                    ...
                                    <option value="{{$k}}" {{ old('country_id')==$k || (isset($employee) &&
                                        old('country_id', $employee->country_id) == $k) ? 'selected' : ''
                                        }}>{{$item}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="fields">
                            ...
                            <div class="four wide field required {{err($errors, 'address_prefecture')}}">
                                ...
                                <select class="ui fluid dropdown" name="address_prefecture">
                                    ...
                                    <option value="{{ $k }}" {{ old('address_prefecture')=="$k" || (isset($employee) &&
                                        old('address_prefecture', $employee->address_prefecture) == "$k") ?
                                        'selected' : '' }}>{{
                                        $value }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="fields">
                            ...
                            <div class="four wide field {{err($errors, 'emergency_address_prefecture1')}}">
                                ...
                                <select class="ui fluid dropdown" name="emergency_address_prefecture1"
                                    ...
                                    <option value="">未選択</option>
                                    @foreach ($prefectures as $k => $value)
                                    <option value="{{ $k }}" {{ old('emergency_address_prefecture1')=="$k" ||
                                        (isset($employee) && old('emergency_address_prefecture1', $employee->
                                        emergency_address_prefecture1) == "$k") ?
                                        'selected' : '' }}>{{
                                        $value }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="fields">
                            ...
                            <div class="four wide field {{err($errors, 'emergency_address_prefecture2')}}">
                                ...
                                <select class="ui fluid dropdown" name="emergency_address_prefecture2"
                                    ...
                                    <option value="">未選択</option>
                                    @foreach ($prefectures as $k => $value)
                                    <option value="{{ $k }}" {{ old('emergency_address_prefecture2')=="$k" ||
                                        (isset($employee) && old('emergency_address_prefecture2', $employee->
                                        emergency_address_prefecture2) == "$k") ?
                                        'selected' : '' }}>{{
                                        $value }}
                                    </option>
                                    @endforeach
                                ...
                                <div class="ui calendar" id="contract_start_date_calendar">
                                    <div class="ui input left icon">
                                        ...
                                        <input type="hidden" name="formatted_contract_start_date"
                                            id="formatted_contract_start_date" value="{{ old('contract_start_date') }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="three fields">
                            <div class="field {{err($errors, 'insurance_loss_reason')}}">
                                ...
                                <select class="ui fluid dropdown" name="insurance_loss_reason"
                                    ...
                                    <option value="{{ $k }}" {{ old('insurance_loss_reason')=="$k" || (isset($employee)
                                        && old('insurance_loss_reason', $employee->
                                        insurance_loss_reason) == "$k") ?
                                        'selected' : '' }}>{{
                                        $value }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="field {{err($errors, 'over_retired_insurance_loss_reason')}}">
                                ...
                                <select class="ui fluid dropdown" name="over_retired_insurance_loss_reason"
                                    ...
                                    <option value="{{ $k }}" {{ old('over_retired_insurance_loss_reason')=="$k" ||
                                        (isset($employee) && old('over_retired_insurance_loss_reason', $employee->
                                        over_retired_insurance_loss_reason) == "$k") ?
                                        'selected' : '' }}>{{
                                        $value }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="two fields">
                            <div class="field {{err($errors, 'occupation_type')}}">
                                ...
                                <select class="ui fluid dropdown" name="occupation_type"
                                    ...
                                    <option value="{{ $k }}" {{ old('occupation_type')=="$k" || (isset($employee) &&
                                        old('occupation_type', $employee->
                                        occupation_type) == "$k") ?
                                        'selected' : '' }}>{{
                                        $value }}
                                    </option>
                    ...
                    <div class="content">
                        ...
                        <div class="two fields">
                            ...
                            <div class="field {{ err($errors, 'pension_office_reference_no') }}">
                                ...
                                <input type="text" id="pension_office_reference_no" name="pension_office_reference_no"
                        ...
                        <div class="two fields">
                            <div class="field {{err($errors, 'labor_insurance_type')}}">
                                ...
                                <select class="ui fluid dropdown" name="labor_insurance_type"
                                    ...
                                    <option value="{{ $k }}" {{ old('labor_insurance_type')=="$k" || (isset($employee)
                                        && old('labor_insurance_type', $employee->labor_insurance_type) == "$k") ?
                                        'selected' : '' }}>{{
                                        $value }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="field {{err($errors, 'employment_insurance_type')}}">
                                ...
                                <select class="ui fluid dropdown" name="employment_insurance_type"
                                    ...
                                    <option value="{{ $k }}" {{ old('employment_insurance_type')=="$k" ||
                                        (isset($employee) && old('employment_insurance_type', $employee->
                                        employment_insurance_type) == "$k") ?
                                        'selected' : '' }}>{{
                                        $value }}
                                    </option>
                                    @endforeach
                            ...
                            <div class="field {{err($errors, 'birthday')}}">
                                ...
                                <div class="ui calendar" id="employment_insured_date_calendar">
                                    <div class="ui input left icon">
                                        ...
                                        <input type="hidden" name="employment_insured_date" id="employment_insured_date"
