                ...
                <div class="content">
                    ...
                    <div class="three fields">
                        ...
                        <div class="field {{err($errors, '')}}">
                            <label for="last_name_alphabet">扶養人数</label>
                            <input type="number" id="last_name_alphabet" name="last_name_alphabet"
                    ...
                    <div class="fields">
                        ...
                        <div class="four wide field required {{err($errors, 'address_prefecture')}}">
                            ...
                            <select class="ui fluid dropdown" name="address_prefecture"
                                value="{{ old('address_prefecture', isset($employee_id) ? $employee->address_prefecture : '') }}">
                                <option value="">未選択</option>
                ...
                <div class="content">
                        ...
                        <div class="field {{err($errors, 'formatted_retirement_date')}}">
                            ...
                            <div class="ui calendar" id="retirement_date_calendar">
                                <div class="ui input left icon">
                                    ...
                                    <input type="hidden" name="formatted_retirement_date" id="formatted_retirement_date"
                    ...
                    <div class="three fields">
                        ...
                        <div class="field {{err($errors, 'over_retired_insurance_loss_reason')}}">
                            <label for="over_retired_insurance_loss_reason">喪失原因</label>
                ...
                <div class="content">
                    ...
                    <div class="two fields">
                        <div class="field {{ err($errors, 'insurance_office_reference_no') }}">
                            ...
                            <input type="text" id="insurance_office_reference_no" name="insurance_office_reference_no"
                        ...
                        <div class="field {{ err($errors, 'employment_insurance_office_no') }}">
                            ...
                            <input type="text" id="employment_insurance_office_no" name="employment_insurance_office_no"
