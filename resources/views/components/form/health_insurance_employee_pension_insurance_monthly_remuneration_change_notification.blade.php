...
<main role="main" class="egovui-main-input-application">
    <form name="inputApplicationForm"
        method="post" action="/recept/application-form-entry"><input type="hidden" name="_csrf" value="345725df-0207-4ba9-b0c8-ad29114f7993"/>
                                ...
                                <form class="egovuiForm-form">
                                    <div class="egov-tool-wrapper">
                                        <div class="egov-tool-field-origin" style="left: 82px; top: 60px;">
                                            <input class="egov-tool-field-rect onImage" id="N4_005F_944E" name="today_year" onfocus="addlength(this,2)" required="required" style="width: 22px; height: 18px; font-size: 10px; text-align: center; line-height: 23px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 112px; top: 60px;">
                                            <input class="egov-tool-field-rect onImage" id="N5_005F_8C8E" name="today_month" onfocus="addlength(this,2)" required="required" style="width: 22px; height: 18px; font-size: 10px; text-align: center; line-height: 23px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 142px; top: 60px;">
                                            <input class="egov-tool-field-rect onImage" id="N6_005F_93FA" name="today_date" onfocus="addlength(this,2)" required="required" style="width: 22px; height: 18px; font-size: 10px; text-align: center; line-height: 23px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 144px; top: 80px;">
                                            <input class="egov-tool-field-rect onImage" id="N7_005F_944E_8D86" maxlength="2" value="{{ old('pension_office_reference_prefecture') }}" name="pension_office_reference_prefecture" required="required" style="width: 50px; height: 25px; font-size: 10px; text-align: left; line-height: 38px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 154px; top: 106px;">
                                            <input class="egov-tool-field-rect onImage" id="N10_005F_93FA" maxlength="3" value="{{ old('branch_post_code_parent') }}" name="branch_post_code_parent" required="required" style="width: 40px; height: 17px; font-size: 10px; text-align: center; line-height: 18px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 218px; top: 106px;">
                                            <input class="egov-tool-field-rect onImage" id="N11_005F_94ED_95DB_8CAF_8ED2_8E81" maxlength="4" value="{{ old('branch_post_code_child') }}" name="branch_post_code_child" required="required" style="width: 45px; height: 17px; font-size: 10px; text-align: center; line-height: 18px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 135px; top: 208px;">
                                            <input class="egov-tool-field-rect onImage" id="N16_005F_905C_90BF" maxlength="5" value="{{ old('branch_tel_area_code') }}" name="branch_tel_area_code" required="required" style="width: 66px; height: 19px; font-size: 10px; text-align: center; line-height: 23px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 206px; top: 208px;">
                                            <input class="egov-tool-field-rect onImage" id="N17_005F_985A_8F5C_8DCE_82C9" maxlength="4" value="{{ old('branch_tel_city_code') }}" name="branch_tel_city_code" required="required" style="width: 65px; height: 19px; font-size: 10px; text-align: center; line-height: 19px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 62px; top: 267px;">
                                            <input class="egov-tool-field-rect onImage" id="N20_005F_94ED_95DB_8CAF_8ED2_94D4_8D866" value="{{ old('insurer_reference_no') }}" name="insurer_reference_no" onfocus="addlength(this,6)" style="width: 55px; height: 40px; font-size: 12px; text-align: right; line-height: 62px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 317px; top: 272px;">
                                            <select class="egov-tool-field-rect onImage" id="N24_005F_8E96_8BC6" value="{{ old('birthday_era') }}" name="birthday_era" required="required" style="width: 46px; height: 30px; font-size: 12px; text-align: left; line-height: 30px; padding: inherit; background-color: rgba(255, 255, 0);">
                                                <option value="1">
                                                明治
                                                </option>
                                                <option value="3">
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 365.5px; top: 277px;">
                                            <input class="egov-tool-field-rect onImage" id="N25_005F_8E96_8BC6_8F8A" value="{{ old('birthday_year') }}" name="birthday_year" onfocus="addlength(this,2)" required="required" style="width: 26px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 393.5px; top: 277px;">
                                            <input class="egov-tool-field-rect onImage" id="N26_005F_8E96_8BC6_8F8A_94D4" value="{{ old('birthday_month') }}" name="birthday_month" onfocus="addlength(this,2)" required="required" style="width: 26px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 422.5px; top: 277px;">
                                            <input class="egov-tool-field-rect onImage" id="N28_8D864_8C85" value="{{ old('birthday_date') }}" name="birthday_date" onfocus="addlength(this,2)" required="required" style="width: 26px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 450px; top: 272px;">
                                            <select class="egov-tool-field-rect onImage" id="N29_005F_8E73" value="{{ old('revision_date_era') }}" name="revision_date_era" required="required" style="width: 46px; height: 30px; font-size: 12px; text-align: left; line-height: 30px; padding: inherit; background-color: rgba(255, 255, 0);">
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 498.8px; top: 277px;">
                                            <input class="egov-tool-field-rect onImage" id="N30_93E0_8BC7_94D4" value="{{ old('revision_date_year') }}" name="revision_date_year" onfocus="addlength(this,2)" required="required" style="width: 26px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 527.5px; top: 277px;">
                                            <input class="egov-tool-field-rect onImage" id="N31__005F_89C1_93FC" value="{{ old('revision_date_month') }}" name="revision_date_month" onfocus="addlength(this,2)" required="required" style="width: 26px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 216px; top: 327px;">
                                            <input class="egov-tool-field-rect onImage" id="N35_94D4_8D86" value="{{ old('before_revision_date_year') }}" name="before_revision_date_year" onfocus="addlength(this,2)" style="width: 34px; height: 16px; font-size: 10px; text-align: center; line-height: 24px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 260px; top: 327px;">
                                            <input class="egov-tool-field-rect onImage" id="N36_005F_8E96_8BC6_8F8A" value="{{ old('before_revision_date_month') }}" name="before_revision_date_month" onfocus="addlength(this,2)" style="width: 34px; height: 16px; font-size: 10px; text-align: center; line-height: 24px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 350px; top: 326.8px;">
                                            <select class="egov-tool-field-rect onImage" id="N38_8F8A_96BC_005F_8F8A_8DDD_926E" value="{{ old('salary_raise_and_reduction') }}" name="salary_raise_and_reduction" required="required" style="width: 70px; height: 15px; font-size: 10px; text-align: left; line-height: 15px; padding: inherit; background-color: rgba(255, 255, 0);">
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 422px; top: 327px;">
                                            <input class="egov-tool-field-rect onImage" id="N39_005F_905C_90BF" value="{{ old('retroactive_payment_month') }}" name="retroactive_payment_month" onfocus="addlength(this,2)" style="width: 34px; height: 16px; font-size: 10px; text-align: center; line-height: 24px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 468px; top: 327px;">
                                            <input class="egov-tool-field-rect onImage" id="N40_905C_90BF_8ED2" maxlength="7" value="{{ old('retroactive_payment_amount') }}" name="retroactive_payment_amount" style="width: 51px; height: 16px; font-size: 10px; text-align: right; line-height: 24px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 63px; top: 388.5px;">
                                            <input class="egov-tool-field-rect onImage" id="N41_005F_96BC_8FCC" value="{{ old('salary_payment_month1') }}" name="salary_payment_month1" onfocus="addlength(this,2)" required="required" style="width: 29px; height: 16px; font-size: 10px; text-align: center; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 148px; top: 406px;">
                                            <input class="egov-tool-field-rect onImage" id="N48_005F_8E73_8A4F_8BC7" maxlength="7" value="{{ old('monthly_salary_currency2') }}" name="monthly_salary_currency2" required="required" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 148px; top: 424px;">
                                            <input class="egov-tool-field-rect onImage" id="N49_005F_8E73_8A4F_8BC8" maxlength="7" value="{{ old('monthly_salary_currency3') }}" name="monthly_salary_currency3" required="required" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 220px; top: 388px;">
                                            <input class="egov-tool-field-rect onImage" id="N50_005F_8E73_8A4F_8BC9" maxlength="7" value="{{ old('monthly_salary_in_kind1') }}" name="monthly_salary_in_kind1" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 220px; top: 406px;">
                                            <input class="egov-tool-field-rect onImage" id="N51_005F_8E73_8A4F_8BC7" maxlength="7" value="{{ old('monthly_salary_in_kind2') }}" name="monthly_salary_in_kind2" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 220px; top: 424px;">
                                            <input class="egov-tool-field-rect onImage" id="N52_005F_8E73_8A4F" maxlength="7" value="{{ old('monthly_salary_in_kind3') }}" name="monthly_salary_in_kind3" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 291px; top: 388px;">
                                            <input class="egov-tool-field-rect onImage" id="N53_005F_8E73_93E0" maxlength="7" value="{{ old('monthly_salary_sum1') }}" name="monthly_salary_sum1" required="required" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 291px; top: 406px;">
                                            <input class="egov-tool-field-rect onImage" id="N54_005F_89C1_93FC_8ED2_94D4_8D86" maxlength="7" value="{{ old('monthly_salary_sum2') }}" name="monthly_salary_sum2" required="required" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 291px; top: 424px;">
                                            <input class="egov-tool-field-rect onImage" id="N55_005F_8E73_8A4F_8BC7_94D4" maxlength="7" value="{{ old('monthly_salary_sum3') }}" name="monthly_salary_sum3" required="required" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 430px; top: 388px;">
                                            <input class="egov-tool-field-rect onImage" id="N56_005F_8E73_8A4F_8BC7_94D7" maxlength="7" value="{{ old('sum') }}" name="sum" required="required" style="width: 92px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 430px; top: 406px;">
                                            <input class="egov-tool-field-rect onImage" id="N57_005F_8E73_8A4F_8BC7_94D9" maxlength="7" value="{{ old('average_amount') }}" name="average_amount" required="required" style="width: 92px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 430px; top: 424px;">
                                            <input class="egov-tool-field-rect onImage" id="N58_005F_8E73_8A4F_8BC7_9410" maxlength="7" value="{{ old('adjusted_average_amount') }}" name="adjusted_average_amount" style="width: 92px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>
                                        <div class="egov-tool-field-origin" style="left: 555px; top: 267px;">
                                            <input class="egov-tool-field-rect onImage" id="N59_005F_8E73_8A4F_8BC7_9412" maxlength="12" value="{{ old('mynumber_no_or_pension_no') }}" name="mynumber_no_or_pension_no" style="width: 142px; height: 40px; font-size: 12px; text-align: left; line-height: 62px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value=""/>
                                        </div>

                                        <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:rgb(255, 255, 0); left: 533px; top: 326px; width: 13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                        ...
                                        <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:rgb(255, 255, 0); left: 533px; top: 339.5px; width:13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                        ...
                                        <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:rgb(255, 255, 0); left: 533px; top: 353px; width:13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                        ...
                                        <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:rgb(255, 255, 0); left: 533px; top: 367.5px; width:13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                        ...
                                        <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:rgb(255, 255, 0); left: 533px; top: 397px; width:13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                        ...
                                        <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:rgb(255, 255, 0); left: 533px; top: 426px; width:13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                        ...
                                        <div class="egov-tool-field-origin" style="left: 576px; top: 425px;">
                                            <input class="egov-tool-field-rect onImage" id="remarks_others" maxlength="10" name="remarks_others" style="width: 101px; height: 16px; font-size: 10px; text-align: left; line-height: 24px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value="{{ old('remarks_others') }}"/>
                                        </div>
                    ...
                    <!-- いる？<script>
                        $(function () {
                            ...
                            if (e.target.getAttribute('pattern')) {
                                ...
                                e.target.setCustomValidity(
                                    e.target.dataset.message ? e.target.dataset.message
                                    : '指定可能な形式で入力してください');
                                }
                            }
                            });
...
<div class="egovui-dialog-content egovui-select-destination" style="display: none;">
    <!--いる？ <script src="/recept/static/js/win/select-sending-organization.js?ver=202106160000"></script> -->
