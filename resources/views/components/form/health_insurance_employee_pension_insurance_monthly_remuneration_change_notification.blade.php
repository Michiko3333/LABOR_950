    ...
    <div id="eGovForm">
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const remarksSalaryRaiseAndReductionReasonsText = document.getElementById(
                    'remarks_salary_raise_and_reduction_reasons_text');
        ...
        <div class="egovuiForm-preview-style egovuiForm-preview-legal-style">
            ...
            <form class="egovuiForm-form">
                <div class="egov-tool-wrapper">
                    ...
                    <div class="egov-tool-field-origin"
                        style="left: 343px; top: 79.5px; width:48px; height: 25.5px; border-top: 1px solid #2f323e; border-right: 1px solid #2f323e;">
                    ...
                    <div class="egov-tool-field-origin" style="left: 135px; top: 152px;">
                        <input class="egov-tool-field-rect onImage" id="N13_005F_8374_838A_834B_8369" maxlength="50"
                    ...
                    <div class="egov-tool-field-origin" style="left: 350px; top: 326.8px;">
                        <select class="egov-tool-field-rect onImage" id="N38_8F8A_96BC_005F_8F8A_8DDD_926E"
                            value="{{ old('salary_raise_and_reduction') }}" name="salary_raise_and_reduction"
                            required="required"
                            style="width: 70px; height: 15px; font-size: 10px; text-align: left; line-height: 15px; padding: inherit; background-color:#ddeeff;">
                    ...
                    <SPAN
                        style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 533px; top: 326px; width: 13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                        <INPUT tabindex="48" value="1" <?php echo old('remarks_over_70_monthly_salary_change') == '1' ? 'checked' : ''; ?>
                            ...
                            type="CHECKBOX" id="N60_005F_8E73_8A4F_8BC7_9432"
                            name="remarks_over_70_monthly_salary_change">
                        <SPAN style="font-size:11px; height:11px; vertical-align:middle;">
                            &nbsp;
                        </SPAN>
                    </SPAN>
                    <SPAN
                        style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 533px; top: 339.5px; width:13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                        <INPUT tabindex="48" value="1" <?php echo old('remarks_multi_work') == '1' ? 'checked' : ''; ?>
                            style="position:absolute; top:1px; left:1px; box-sizing:border-box; -moz-box-sizing:border-box; width:10px; height:10px; margin:auto;"
                            type="CHECKBOX" id="N61_005F_8E73_8A4F_8BC7_94DD" name="remarks_multi_work">
                        <SPAN style="font-size:11px; height:11px; vertical-align:middle;">
                            &nbsp;
                        </SPAN>
                    </SPAN>
                    <SPAN
                        style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 533px; top: 353px; width:13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                        <INPUT tabindex="48" value="1" <?php echo old('remarks_part_time_workers') == '1' ? 'checked' : ''; ?>
                            style="position:absolute; top:1px; left:1px; box-sizing:border-box; -moz-box-sizing:border-box; width:10px; height:10px; margin:auto;"
                            type="CHECKBOX" id="N62_005F_8E73_8A4F_8BC7_94DC" name="remarks_part_time_workers">
                        <SPAN style="font-size:11px; height:11px; vertical-align:middle;">
                            &nbsp;
                        </SPAN>
                    </SPAN>
                    <SPAN
                        style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 533px; top: 367.5px; width:13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                        <INPUT tabindex="48" value="1" <?php echo old('remarks_salary_raise_and_reduction_reasons') == '1' ? 'checked' : ''; ?>
                            style="position:absolute; top:1px; left:1px; box-sizing:border-box; -moz-box-sizing:border-box; width:10px; height:10px; margin:auto;"
                            type="CHECKBOX" id="N63_005F_8E73_8A4F_8BC7_9467"
                            name="remarks_salary_raise_and_reduction_reasons">
                        <SPAN style="font-size:11px; height:11px; vertical-align:middle;">
                            &nbsp;
                        </SPAN>
                    </SPAN>
                    <SPAN
                        style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 533px; top: 397px; width:13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                        <INPUT tabindex="48" value="1" <?php echo old('remarks_only_health_insurance_salary_change') == '1' ? 'checked' : ''; ?>
                            style="position:absolute; top:1px; left:1px; box-sizing:border-box; -moz-box-sizing:border-box; width:10px; height:10px; margin:auto;"
                            type="CHECKBOX" id="N64_005F_8F5A_8F8A"
                            name="remarks_only_health_insurance_salary_change">
                        <SPAN style="font-size:11px; height:11px; vertical-align:middle;">
                            &nbsp;
                        </SPAN>
                    </SPAN>
                    <SPAN
                        style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 533px; top: 426px; width:13px; line-height:12px; height:12px; text-align:left; font-size:12px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                        <INPUT tabindex="48" value="1" <?php echo old('remarks_and_others') == '1' ? 'checked' : ''; ?>
                            style="position:absolute; top:1px; left:1px; box-sizing:border-box; -moz-box-sizing:border-box; width:10px; height:10px; margin:auto;"
                            type="CHECKBOX" id="N65_005F_8F5A_8F8B" name="remarks_and_others">
                        <SPAN style="font-size:11px; height:11px; vertical-align:middle;">
                            &nbsp;
                        </SPAN>
                    </SPAN>
                    <div class="egov-tool-field-origin" style="left: 552px; top: 381px;">
                        <input class="egov-tool-field-rect onImage" disabled
