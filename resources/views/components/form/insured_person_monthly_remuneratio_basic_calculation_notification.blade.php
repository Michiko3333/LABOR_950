                                    ...
                                    <form class="egovuiForm-form">
                                        <div class="egov-tool-wrapper">
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 62px; top: 269px;">
                                                <input class="egov-tool-field-rect onImage" id="N19_005F_94ED_95DB_8CAF_8ED2_94D4_8D864_8C85" name="Insured_person_reference_number" maxlength="6" style="width: 55px; height: 38px; font-size: 9px; text-align: right; line-height: 62px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('Insured_person_reference_number') }}" maxlength="6"/>
                                            </div>
