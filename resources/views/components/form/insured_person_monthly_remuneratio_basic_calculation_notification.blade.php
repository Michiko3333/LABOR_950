                                    ...
                                    <form class="egovuiForm-form">
                                        <div class="egov-tool-wrapper">
                                            <div class="egov-tool-field-origin" style="left: 82px; top: 60px;">
                                                <input class="egov-tool-field-rect onImage" id="N3_005F_944E_8D86" name="today_japan_era_year" required="required" style="width: 22px; height: 18px; font-size: 10px; text-align: center; line-height: 27px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('today_japan_era_year') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 112px; top: 60px;">
                                                <input class="egov-tool-field-rect onImage" id="N4_005F_944E" name="today_japan_era_month" required="required" style="width: 22px; height: 18px; font-size: 10px; text-align: center; line-height: 27px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('today_japan_era_month') }}"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 144px; top: 80px;">
                                                <input class="egov-tool-field-rect onImage" id="N6_005F_93FA" maxlength="2" name="pension_office_reference_prefecture" required="required" style="width: 50px; height: 24px; font-size: 12px; text-align: left; line-height: 37px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('pension_office_reference_prefecture') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 195.5px; top: 80px;">
                                                <input class="egov-tool-field-rect onImage" id="N7_005F_944E_8D86" maxlength="2" name="pension_office_reference_no_cities" required="required" style="width: 50px; height: 24px; font-size: 12px; text-align: left; line-height: 37px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('pension_office_reference_no_cities') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 246.5px; top: 80px;">
                                                <input class="egov-tool-field-rect onImage" id="N8_005F_944E" maxlength="4" name="pension_office_reference_no_office" required="required" style="width: 50px; height: 24px; font-size: 12px; text-align: left; line-height: 37px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('pension_office_reference_no_office') }}"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 343px; top: 79.5px; width:47px; height: 25.5px; border-top: 1px solid #2f323e; border-right: 1px solid #2f323e;">
                                                <input class="egov-tool-field-rect onImage" id="N9_005F_8C8E0" maxlength="5" value="{{ old('csv_pension_office_no') }}" name="csv_pension_office_no" required="required" style="width: 46px; height: 25px; font-size: 10px; text-align: left; line-height: 38px; padding: inherit; background-color:#ddeeff;" type="text" value=""/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 135px; top: 180px;">
                                                <input class="egov-tool-field-rect onImage" id="N13_005F_8374_838A_834B_8369" maxlength="25" name="business_owner_name" required="required" style="width: 253px; height: 27px; font-size: 10px; text-align: left; line-height: 12px; padding: 3px; background-color:#ddeeff; overflow-wrap: break-word; word-wrap: break-word;" type="text" value="{{ old('business_owner_name') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 135px; top: 208px;">
                                                <input class="egov-tool-field-rect onImage" id="N15_005F_94ED_95DB_8CAF_8ED2_8E81_96BC" maxlength="5" name="branch_tel_area_code" required="required" style="width: 66px; height: 19px; font-size: 10px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('branch_tel_area_code') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 206px; top: 208px;">
                                                <input class="egov-tool-field-rect onImage" id="N16_005F_905C_90BF" maxlength="4" name="branch_tel_city_code" required="required" style="width: 65px; height: 19px; font-size: 10px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('branch_tel_city_code') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 284px; top: 208px;">
                                                <input class="egov-tool-field-rect onImage" id="N17_005F_985A_8F5C_8DCE_82C9" maxlength="5" name="branch_tel_subscriber_code" required="required" style="width: 66px; height: 19px; font-size: 10px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('branch_tel_subscriber_code') }}"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 62px; top: 269px;">
                                                <input class="egov-tool-field-rect onImage" id="N19_005F_94ED_95DB_8CAF_8ED2_94D4_8D864_8C85" name="Insured_person_reference_number" onfocus="addlength(this,6)" style="width: 55px; height: 38px; font-size: 9px; text-align: right; line-height: 62px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('Insured_person_reference_number') }}" maxlength="6"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 421px; top: 277px;">
                                                <input class="egov-tool-field-rect onImage" id="N26_005F_8E96_8BC6_8F8A_94D4" name="date_of_birth" required="required" style="width: 27px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('date_of_birth') }}"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 216px; top: 327px;">
                                                <input class="egov-tool-field-rect onImage" id="N33_005F_8E73_8A4F" name="previous_revision_year" maxlength="4" style="width: 35px; height: 16px; font-size: 10px; text-align: center; line-height: 24px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('previous_revision_year') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 260px; top: 327px;">
                                                <input class="egov-tool-field-rect onImage" id="N34_93E0_8BC7_94D4" name="previous_revision_month" style="width: 35px; height: 16px; font-size: 10px; text-align: center; line-height: 24px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('previous_revision_month') }}"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 603px; top: 341px;">
                                                <input class="egov-tool-field-rect onImage" id="N64_005F_8F5A_8F8A" name="remarks_calculation_basic_month_month1" style="width: 35px; height: 14px; font-size: 10px; text-align: center; line-height: 18px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('remarks_calculation_basic_month_month1') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 646px; top: 341px;">
                                                <input class="egov-tool-field-rect onImage" id="N65_005F_8F5A_8F8B" name="remarks_calculation_basic_month_month2" style="width: 34px; height: 14px; font-size: 10px; text-align: center; line-height: 18px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('remarks_calculation_basic_month_month2') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 575px; top: 418px;">
                                                <input class="egov-tool-field-rect onImage" id="N66_005F_8F5A" maxlength="10" name="others" style="width: 102px; height: 14px; font-size: 10px; text-align: left; line-height: 19px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('others') }}"/>
                                            </div>
