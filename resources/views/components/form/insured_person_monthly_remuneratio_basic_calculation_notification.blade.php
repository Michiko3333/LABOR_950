                                    ...
                                    <form class="egovuiForm-form">
                                        <div class="egov-tool-wrapper">
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 135px; top: 152px;">
                                                <input class="egov-tool-field-rect onImage" id="N12_005F_905C_90BF_8ED2_8E81" maxlength="50" name="business_name" required="required" style="width: 253px; height: 27px; font-size: 10px; text-align: left; line-height: 12px; padding: 3px; background-color:#ddeeff; overflow-wrap: break-word; word-wrap: break-word;" type="text" value="{{ old('business_name') }}"/>
                                            </div>
