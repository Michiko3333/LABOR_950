                                    ...
                                    <form class="egovuiForm-form">
                                        <div class="egov-tool-wrapper">
                                            <div class="egov-tool-field-origin" style="left: 82px; top: 60px;">
                                                <input class="egov-tool-field-rect onImage" id="N3_005F_944E_8D86" name="today_japan_era_year" required="required" style="width: 22px; height: 18px; font-size: 10px; text-align: center; line-height: 27px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value="{{ old('today_japan_era_year') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 112px; top: 60px;">
                                                <input class="egov-tool-field-rect onImage" id="N4_005F_944E" name="today_japan_era_month" required="required" style="width: 22px; height: 18px; font-size: 10px; text-align: center; line-height: 27px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value="{{ old('today_japan_era_month') }}"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 218px; top: 106px;">
                                                <input class="egov-tool-field-rect onImage" id="N10_005F_93FA" maxlength="4" name="post_code_latter" required="required" style="width: 45px; height: 17px; font-size: 10px; text-align: center; line-height: 25px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value="{{ old('post_code_latter') }}"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 421px; top: 277px;">
                                                <input class="egov-tool-field-rect onImage" id="N26_005F_8E96_8BC6_8F8A_94D4" name="date_of_birth" required="required" style="width: 27px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value="{{ old('date_of_birth') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 450px; top: 272px;">
                                                <select class="egov-tool-field-rect onImage" id="N28_8D864_8C85" name="applicable_era_name" required="required" style="width: 46px; height: 30px; font-size: 12px; text-align: left; line-height: 30px; padding: inherit; background-color: rgba(255, 255, 0);">
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 603px; top: 341px;">
                                                <input class="egov-tool-field-rect onImage" id="N64_005F_8F5A_8F8A" name="remarks_calculation_basic_month_month1" style="width: 35px; height: 14px; font-size: 10px; text-align: center; line-height: 18px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value="{{ old('remarks_calculation_basic_month_month1') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 646px; top: 341px;">
                                                <input class="egov-tool-field-rect onImage" id="N65_005F_8F5A_8F8B" name="remarks_calculation_basic_month_month2" style="width: 34px; height: 14px; font-size: 10px; text-align: center; line-height: 18px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value="{{ old('remarks_calculation_basic_month_month2') }}"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 575px; top: 418px;">
                                                <input class="egov-tool-field-rect onImage" id="N66_005F_8F5A" maxlength="10" name="others" style="width: 102px; height: 14px; font-size: 10px; text-align: left; line-height: 19px; padding: inherit; background-color: rgba(255, 255, 0);" type="text" value="{{ old('others') }}"/>
                                            </div>
