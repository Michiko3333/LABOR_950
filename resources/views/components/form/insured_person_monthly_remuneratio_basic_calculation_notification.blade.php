<!-- 4950013521024000 -->
<!-- 健康保険・厚生年金保険被保険者報酬月額算定基礎届／７０歳以上被用者算定基礎届（ＣＳＶファイル添付方式）（２０２４年１２月以降手続き） -->
                            ...
                            <div id="eGovForm">
                                ...
                                <div class="egovuiForm-preview-style egovuiForm-preview-legal-style">
                                    <style>
                                        ...
                                        .egovuiForm-preview-style.egovuiForm-preview-legal-style img {
                                    ...
                                    <form class="egovuiForm-form">
                                        <div class="egov-tool-wrapper">
                                            <div class="egov-tool-field-origin" style="left: 82px; top: 60px;">
                                                <input class="egov-tool-field-rect onImage" id="N3_005F_944E_8D86" name="today_japan_era_year" required="required" style="width: 22px; height: 18px; font-size: 10px; text-align: center; line-height: 27px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('today_japan_era_year') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 112px; top: 60px;">
                                                <input class="egov-tool-field-rect onImage" id="N4_005F_944E" name="today_japan_era_month" required="required" style="width: 22px; height: 18px; font-size: 10px; text-align: center; line-height: 27px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('today_japan_era_month') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 142px; top: 60px;">
                                                <input class="egov-tool-field-rect onImage" id="N5_005F_8C8E" name="today_japan_era_day" required="required" style="width: 22px; height: 18px; font-size: 10px; text-align: center; line-height: 27px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('today_japan_era_day') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 144px; top: 80px;">
                                                <input class="egov-tool-field-rect onImage" id="N6_005F_93FA" maxlength="2" name="pension_office_reference_prefecture" required="required" style="width: 50px; height: 24px; font-size: 12px; text-align: left; line-height: 37px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('pension_office_reference_prefecture') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 195.5px; top: 80px;">
                                                <input class="egov-tool-field-rect onImage" id="N7_005F_944E_8D86" maxlength="2" name="pension_office_reference_no_cities" required="required" style="width: 50px; height: 24px; font-size: 12px; text-align: left; line-height: 37px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('pension_office_reference_no_cities') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 246.5px; top: 80px;">
                                                <input class="egov-tool-field-rect onImage" id="N8_005F_944E" maxlength="4" name="pension_office_reference_no_office" required="required" style="width: 50px; height: 24px; font-size: 12px; text-align: left; line-height: 37px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('pension_office_reference_no_office') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 298px; top: 79.5px; width: 45px; height: 25.5px; border-top: 1px solid #2f323e; border-right: 1px solid #2f323e;">
                                                <p style="margin-left: 2px; font-size: 8px; font-weight: 500; line-height: 25px;">事業所番号</p>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 343px; top: 79.5px; width:47px; height: 25.5px; border-top: 1px solid #2f323e; border-right: 1px solid #2f323e;">
                                                <input class="egov-tool-field-rect onImage" id="N9_005F_8C8E0" maxlength="5" value="{{ old('csv_pension_office_no') }}" name="csv_pension_office_no" required="required" style="width: 46px; height: 25px; font-size: 10px; text-align: left; line-height: 38px; padding: inherit; background-color:#ddeeff;" type="text" value="" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 154px; top: 106px;">
                                                <input class="egov-tool-field-rect onImage" id="N9_005F_8C8E" maxlength="3" name="post_code_former" required="required" style="width: 40px; height: 17px; font-size: 10px; text-align: center; line-height: 25px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('post_code_former') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 218px; top: 106px;">
                                                <input class="egov-tool-field-rect onImage" id="N10_005F_93FA" maxlength="4" name="post_code_latter" required="required" style="width: 45px; height: 17px; font-size: 10px; text-align: center; line-height: 25px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('post_code_latter') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 135px; top: 124px;">
                                                <input class="egov-tool-field-rect onImage" id="N11_005F_94ED_95DB_8CAF_8ED2_8E81" maxlength="75" name="business_location" required="required" style="width: 253px; height: 27px; font-size: 10px; text-align: left; line-height: 12px; padding: 3px; background-color:#ddeeff; overflow-wrap: break-word; word-wrap: break-word;" type="text" value="{{ old('business_location') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 135px; top: 152px;">
                                                <input class="egov-tool-field-rect onImage" id="N12_005F_905C_90BF_8ED2_8E81" maxlength="40" name="business_name" required="required" style="width: 253px; height: 27px; font-size: 10px; text-align: left; line-height: 12px; padding: 3px; background-color:#ddeeff; overflow-wrap: break-word; word-wrap: break-word;" type="text" value="{{ old('business_name') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 135px; top: 180px;">
                                                <input class="egov-tool-field-rect onImage" id="N13_005F_8374_838A_834B_8369" maxlength="25" name="business_owner_name" required="required" style="width: 253px; height: 27px; font-size: 10px; text-align: left; line-height: 12px; padding: 3px; background-color:#ddeeff; overflow-wrap: break-word; word-wrap: break-word;" type="text" value="{{ old('business_owner_name') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 135px; top: 208px;">
                                                <input class="egov-tool-field-rect onImage" id="N15_005F_94ED_95DB_8CAF_8ED2_8E81_96BC" maxlength="5" name="branch_tel_area_code" required="required" style="width: 66px; height: 19px; font-size: 10px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('branch_tel_area_code') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 206px; top: 208px;">
                                                <input class="egov-tool-field-rect onImage" id="N16_005F_905C_90BF" maxlength="4" name="branch_tel_city_code" required="required" style="width: 65px; height: 19px; font-size: 10px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('branch_tel_city_code') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 284px; top: 208px;">
                                                <input class="egov-tool-field-rect onImage" id="N17_005F_985A_8F5C_8DCE_82C9" maxlength="5" name="branch_tel_subscriber_code" required="required" style="width: 66px; height: 19px; font-size: 10px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('branch_tel_subscriber_code') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 398.3px; top: 193px;">
                                                <input class="egov-tool-field-rect onImage" id="N18_005F_8CC2_906C_94D4" maxlength="40" name="labor_consultant_name" style="width: 293.5px; height: 34px; font-size: 12px; text-align: left; line-height: 12px; padding: 3px; background-color:#ddeeff; overflow-wrap: break-word; word-wrap: break-word;" type="text" value="{{ old('labor_consultant_name') }}" autocomplete="off"/>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 317px; top: 272px;">
                                                <select class="egov-tool-field-rect onImage" id="N23__005F_94ED" name="era_name" required="required" style="width: 46px; height: 30px; font-size: 12px; text-align: left; line-height: 30px; padding: inherit; background-color:#ddeeff;">
                                                    <option value="1" {{ old('era_name') == '1' ? 'selected' : '' }}>
                                                    明治
                                                    </option>
                                                    <option value="3" {{ old('era_name') == '3' ? 'selected' : '' }}>
                                                    大正
                                                    </option>
                                                    <option value="5" {{ old('era_name') == '5' ? 'selected' : '' }} selected="selected">
                                                    昭和
                                                    </option>
                                                    <option value="7" {{ old('era_name') == '7' ? 'selected' : '' }}>
                                                    平成
                                                    </option>
                                                    <option value="9" {{ old('era_name') == '9' ? 'selected' : '' }}>
                                                    令和
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 365px; top: 277px;">
                                                <input class="egov-tool-field-rect onImage" id="N24_005F_8E96_8BC6" name="year_of_birth" required="required" style="width: 26px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('year_of_birth') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 393px; top: 277px;">
                                                <input class="egov-tool-field-rect onImage" id="N25_005F_8E96_8BC6_8F8A" name="month_of_birth" required="required" style="width: 27px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('month_of_birth') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 421px; top: 277px;">
                                                <input class="egov-tool-field-rect onImage" id="N26_005F_8E96_8BC6_8F8A_94D4" name="date_of_birth" required="required" style="width: 27px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('date_of_birth') }}" autocomplete="off"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 500px; top: 277px;">
                                                <input class="egov-tool-field-rect onImage" id="N29_005F_8E73" name="applicable_year" required="required" style="width: 25px; height: 24px; font-size: 12px; text-align: center; line-height: 30px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('applicable_year') }}" autocomplete="off"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 216px; top: 327px;">
                                                <input class="egov-tool-field-rect onImage" id="N33_005F_8E73_8A4F" name="previous_revision_year" maxlength="4" style="width: 35px; height: 16px; font-size: 10px; text-align: center; line-height: 24px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('previous_revision_year') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 260px; top: 327px;">
                                                <input class="egov-tool-field-rect onImage" id="N34_93E0_8BC7_94D4" name="previous_revision_month" style="width: 35px; height: 16px; font-size: 10px; text-align: center; line-height: 24px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('previous_revision_month') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 306px; top: 327px;">
                                                <input class="egov-tool-field-rect onImage" id="N35_94D4_8D86" name="monthly_salary_increase" style="width: 35px; height: 16px; font-size: 10px; text-align: center; line-height: 24px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('monthly_salary_increase') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 350px; top: 327.5px;">
                                                <select class="egov-tool-field-rect onImage" id="N36_005F_8E96_8BC6_8F8A" name="salary_increase" required="required" style="width: 70px; height: 15px; font-size: 10px; text-align: left; line-height: 15px; padding: inherit; background-color:#ddeeff;">
                                                    ...
                                                    <option value="降給" {{ old('salary_increase') == '降給' ? 'selected' : '' }}>
                                                    降給
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 422px; top: 327px;">
                                                <input class="egov-tool-field-rect onImage" id="N37_96BC_005F_8F8A_8DDD_926E" name="retroactive_payment_amount_month" style="width: 35px; height: 16px; font-size: 10px; text-align: center; line-height: 24px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('retroactive_payment_amount_month') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 468px; top: 327px;">
                                                <input class="egov-tool-field-rect onImage" id="N38_8F8A_96BC_005F_8F8A_8DDD_926E" maxlength="7" name="retroactive_payment_amount" style="width: 52px; height: 16px; font-size: 10px; text-align: right; line-height: 24px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('retroactive_payment_amount') }}" autocomplete="off"/>
                                            </div>
                                            ...
                                            <div class="egov-tool-field-origin" style="left: 220px; top: 425px;">
                                                <input class="egov-tool-field-rect onImage" id="N47_005F_89C1_93FC_8ED2_94D4_8D86" maxlength="7" name="monthly_remuneration_amount_in_kind3" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('monthly_remuneration_amount_in_kind3') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 291px; top: 389px;">
                                                <input class="egov-tool-field-rect onImage" id="N48_005F_8E73_8A4F_8BC7" maxlength="7" name="monthly_remuneration_total1" required="required" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit;" readonly type="text" value="{{ old('monthly_remuneration_total1') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 291px; top: 407px;">
                                                <input class="egov-tool-field-rect onImage" id="N49_005F_8E73_8A4F_8BC8" maxlength="7" name="monthly_remuneration_total2" required="required" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit;" readonly type="text" value="{{ old('monthly_remuneration_total2') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 291px; top: 425px;">
                                                <input class="egov-tool-field-rect onImage" id="N50_005F_8E73_8A4F_8BC9" maxlength="7" name="monthly_remuneration_total3" required="required" style="width: 60px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit;" readonly type="text" value="{{ old('monthly_remuneration_total3') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 430px; top: 389px;">
                                                <input class="egov-tool-field-rect onImage" id="N51_005F_8E73_8A4F_8BC7" maxlength="7" name="grand_total" required="required" style="width: 91px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit;" readonly type="text" value="{{ old('grand_total') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 430px; top: 407px;">
                                                <input class="egov-tool-field-rect onImage" id="N52_005F_8E73_8A4F" maxlength="7" name="average_amount" required="required" style="width: 91px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit;" readonly type="text" value="{{ old('average_amount') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 430px; top: 425px;">
                                                <input class="egov-tool-field-rect onImage" id="N53_005F_8E73_93E0" maxlength="7" name="adjusted_average_amount" style="width: 91px; height: 16px; font-size: 10px; text-align: right; line-height: 25px; padding: inherit;" readonly type="text" value="{{ old('adjusted_average_amount') }}" autocomplete="off"/>
                                            </div>


                                            <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 534px; top: 327px; width:12px; line-height:12px; height:13px; text-align:left; font-size:13px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                            ...
                                            <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 534px; top: 357px; width:12px; line-height:12px; height:13px; text-align:left; font-size:13px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                            <INPUT tabindex="50" value="1" style="position:absolute; top:1px; left:1px; box-sizing:border-box; -moz-box-sizing:border-box; width:11px; height:10px; margin:auto;"
                                            ...
                                            <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 534px; top: 373px; width:12px; line-height:12px; height:13px; text-align:left; font-size:13px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                            <INPUT tabindex="50" value="1" style="position:absolute; top:1px; left:1px; box-sizing:border-box; -moz-box-sizing:border-box; width:11px; height:10px; margin:auto;"
                                            ...
                                            <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 534px; top: 388px; width:12px; line-height:12px; height:13px; text-align:left; font-size:13px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                            <INPUT tabindex="50" value="1" style="position:absolute; top:1px; left:1px; box-sizing:border-box; -moz-box-sizing:border-box; width:11px; height:10px; margin:auto;"
                                            ...
                                            <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 534px; top: 404px; width:12px; line-height:12px; height:13px; text-align:left; font-size:13px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                            <INPUT tabindex="50" value="1" style="position:absolute; top:1px; left:1px; box-sizing:border-box; -moz-box-sizing:border-box; width:11px; height:10px; margin:auto;"
                                            ...
                                            <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 534px; top: 420px; width:12px; line-height:12px; height:13px; text-align:left; font-size:13px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                            <INPUT tabindex="50" value="1" style="position:absolute; top:1px; left:1px; box-sizing:border-box; -moz-box-sizing:border-box; width:11px; height:10px; margin:auto;"
                                            ...
                                            <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 598px; top: 357px; width:12px; line-height:12px; height:13px; text-align:left; font-size:13px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                            <INPUT tabindex="50" value="1" style="position:absolute; top:1px; left:0px; box-sizing:border-box; -moz-box-sizing:border-box; width:11px; height:10px; margin:auto;"
                                                type="CHECKBOX" id="N61_005F_8E73_8A4F_8BC7_94DD" name="remarks_and_part" <?php echo old('remarks_and_part') == '1' ? 'checked' : ''; ?>/>
                                                <SPAN style="font-size:11px; height:11px; vertical-align:middle;">&nbsp;</SPAN></SPAN>

                                            <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 598px; top: 373px; width:12px; line-height:12px; height:13px; text-align:left; font-size:13px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                            <INPUT tabindex="50" value="1" style="position:absolute; top:1px; left:0px; box-sizing:border-box; -moz-box-sizing:border-box; width:11px; height:10px; margin:auto;"
                                            ...
                                            <SPAN style="position:absolute; box-sizing:border-box; -moz-box-sizing:border-box; overflow:hidden; color:rgb(0, 0, 0); background-color:#ddeeff; left: 598px; top: 404px; width:12px; line-height:12px; height:13px; text-align:left; font-size:13px; font-family:'ＭＳ 明朝', serif; white-space:nowrap;">
                                            <INPUT tabindex="50" value="1" style="position:absolute; top:1px; left:0px; box-sizing:border-box; -moz-box-sizing:border-box; width:11px; height:10px; margin:auto;"
                                                type="CHECKBOX" id="N63_005F_8E73_8A4F_8BC7_9467" name="remarks_and_others" <?php echo old('remarks_and_others') == '1' ? 'checked' : ''; ?>/>
                                                <SPAN style="font-size:11px; height:11px; vertical-align:middle;">&nbsp;</SPAN></SPAN>

                                            <div class="egov-tool-field-origin" style="left: 603px; top: 341px;">
                                                <input class="egov-tool-field-rect onImage" id="N64_005F_8F5A_8F8A" name="remarks_calculation_basic_month_month1" style="width: 35px; height: 14px; font-size: 10px; text-align: center; line-height: 18px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('remarks_calculation_basic_month_month1') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 646px; top: 341px;">
                                                <input class="egov-tool-field-rect onImage" id="N65_005F_8F5A_8F8B" name="remarks_calculation_basic_month_month2" style="width: 34px; height: 14px; font-size: 10px; text-align: center; line-height: 18px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('remarks_calculation_basic_month_month2') }}" autocomplete="off"/>
                                            </div>
                                            <div class="egov-tool-field-origin" style="left: 575px; top: 418px;">
                                                <input class="egov-tool-field-rect onImage" id="N66_005F_8F5A" maxlength="10" name="others" style="width: 102px; height: 14px; font-size: 10px; text-align: left; line-height: 19px; padding: inherit; background-color:#ddeeff;" type="text" value="{{ old('others') }}" autocomplete="off"/>
                                            </div>
