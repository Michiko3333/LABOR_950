                    ...
                    <form class="egovuiForm-form">
                        <div class="egov-tool-wrapper">
                            ...
                            <div class="egov-tool-field-origin" style="left: 173px; top: 149px;">
                                <input class="egov-tool-field-rect onImage" id="N16_005F_905C_90BF" maxlength="40" name="branch_name" required="required" style="width: 277px; height: 28px; font-size: 10px; text-align: left; line-height: 12px; padding: 3px; background-color:#ddeeff; overflow-wrap: break-word; word-wrap: break-word;" value="{{ old('branch_name') }}">
                            </div>
