    ...
    public function run(): void
    {
        ...
        DB::table('m_ledger')->insert([
            [
                ...
                'formal_procedure_name' => '雇用保険被保険者資格取得届（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：資格取得届',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険被保険者資格喪失届（離職票交付なし）（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：資格喪失届(離職票なし)',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険被保険者資格喪失届（離職票交付あり）（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：資格喪失届(離職票あり)',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険被保険者転勤届（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：転勤届',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険被保険者休業開始時賃金月額証明書又は同休業・所定労働時間短縮開始時賃金証明書の提出（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：休業・短縮賃金証明申請',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険高年齢雇用継続給付（高年齢雇用継続基本給付金）の申請（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：高年齢雇用継続給付(基本給付金)',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険高年齢雇用継続給付（高年齢再就職給付金）の申請（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：高年齢雇用継続給付(再就職給付金)',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険育児休業給付（育児休業給付金）の申請（初回申請）（令和４年１０月以降手続き）／電子申請',
                'abbreviation' => '雇：育児休業給付申請(初回)',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険育児休業給付（育児休業給付金）の申請（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：育児休業給付申請',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険被保険者六十歳到達時等賃金証明書の提出及び高年齢雇用継続給付受給資格確認・高年齢雇用継続給付（高年齢雇用継続基本給付金・高年齢再就職給付金）の申請（初回申請）（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：60歳賃金証明・高年齢給付申請(初回)',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険被保険者六十歳到達時等賃金証明書の提出及び高年齢雇用継続給付受給資格確認（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：60歳賃金証明・高年齢給付申請',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
                ...
                'formal_procedure_name' => '雇用保険介護休業給付（介護休業給付金）の申請（令和４年６月以降手続き）／電子申請',
                'abbreviation' => '雇：介護休業給付申請',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
            ...
            [
                ...
                'formal_procedure_name' => '健康保険・厚生年金保険被保険者資格喪失届（単記用）（２０１９年５月以降手続き）／電子申請',
                'abbreviation' => '健・厚：資格喪失届',
                'procedure_type' => NULL,
                'delete_flg' => '0',
            ],
            [
            ...
            [
                ...
                'formal_procedure_name' => '健康保険・厚生年金保険賞与不支給報告書／電子申請',
