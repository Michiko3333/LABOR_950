    ...
    public function run(): void
    {
        DB::table('m_ledger')->insert([
            ...
            [
                ...
                'procedure_name' => '月額変更届（CSVのみ）/ 健康保険・厚生年金保険被保険者報酬月額変更届／70歳以上被用者月額変更届（ＣＳＶファイル添付方式）', 
                'procedure_type' => NULL, 
                'delete_flg' => '0', 
            ],
            [
                ...
                'procedure_name' => '算定基礎届（CSVのみ）/ 健康保険・厚生年金保険被保険者報酬月額算定基礎届／70歳以上被用者算定基礎届（ＣＳＶファイル添付方式）', 
                'procedure_type' => NULL, 
                'delete_flg' => '0', 
            ],
            [
                ...
                'procedure_name' => '健康保険・厚生年金保険被保険者賞与支払届／７０歳以上被用者賞与支払届（ＣＳＶファイル添付方式）（２０２２年１０月以降手続き）／電子申請', 
                'procedure_type' => NULL, 
                'delete_flg' => '0', 
            ],
            [
