    ...
    public function run(): void
    {
        DB::table('m_application_form')->insert([
            ...
            [
                'id' => '21', 
                'ledger_id' => '16', 
                'style_id' => '4950013520731000', 
                'style_name' => '健康保険・厚生年金保険被保険者報酬月額変更届（単記用）（２０１９年５月以降手続き）／電子申請', 
                'delete_flg' => '0', 
            ],
            [
                'id' => '22', 
                ...
                'style_name' => '健康保険・厚生年金保険被保険者報酬月額算定基礎届（単記用）（２０１９年５月以降手続き）／電子申請', 
                'delete_flg' => '0', 
            ],
            [
                'id' => '23', 
                ...
                'style_name' => '健康保険・厚生年金保険被保険者賞与支払届（単記用）（２０１９年５月以降手続き）／電子申請', 
                'delete_flg' => '0', 
            ],
            [
                'id' => '24', 
