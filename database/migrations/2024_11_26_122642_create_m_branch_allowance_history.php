...
return new class extends Migration
{
    ...
    {
        Schema::create('m_branch_allowance_history', function (Blueprint $table) {
            $table->id();
            $table->integer('allowance_id')->comment('手当ID');
    ...
    {
        Schema::dropIfExists('m_branch_allowance_history');
    }
};
