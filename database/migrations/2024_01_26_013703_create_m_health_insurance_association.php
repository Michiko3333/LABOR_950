...
return new class extends Migration
{
    ...
    {
        Schema::create('m_health_insurance_association', function (Blueprint $table) {
            $table->id()->autoIncrement()->comment('健康保険協会ID');
    ...
    {
        Schema::dropIfExists('m_health_insurance_association');
    }
};
