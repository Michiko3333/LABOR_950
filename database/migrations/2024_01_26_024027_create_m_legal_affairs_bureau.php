...
return new class extends Migration
{
    ...
    {
        Schema::create('m_legal_affairs_bureau', function (Blueprint $table) {
            $table->id()->autoIncrement()->comment('法務局ID');
            $table->string('name', 255)->nullable()->comment('法務局名');
            $table->string('name_kana', 255)->nullable()->comment('法務局名（カナ）');
    ...
    {
        Schema::dropIfExists('m_legal_affairs_bureau');
    }
};
