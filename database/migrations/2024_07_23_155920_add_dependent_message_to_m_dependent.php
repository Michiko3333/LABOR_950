...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('m_dependent', function (Blueprint $table) {
            ...
            $table->integer('relationship_spouse')->nullable()->comment('続柄（配偶者）');
            $table->integer('relationship_dependent')->nullable()->comment('続柄（扶養者）');
            $table->tinyInteger('spouse_flag')->nullable()->comment('配偶者フラグ');
            $table->integer('age')->nullable()->comment('年齢');
            $table->string('contact',255)->nullable()->comment('連絡先');
            $table->string('occupation',255)->nullable()->comment('職業');
            $table->date('date_of_authorisation')->nullable()->comment('認定日');
            $table->date('date_of_expiry')->nullable()->comment('抹消日');
            $table->integer('dependent_type')->nullable()->comment('扶養区分');
            ...
            $table->tinyInteger('delete_flg')->default(0)->nullable()->comment('削除フラグ');
            $table->timestamps();
