...
return new class extends Migration
{
    ...
    {
        Schema::create('m_bounty_history', function (Blueprint $table) {
            $table->id();
            $table->integer('bounty_id')->comment('報奨金ID');
    ...
    {
        Schema::dropIfExists('m_bounty_history');
    }
};
