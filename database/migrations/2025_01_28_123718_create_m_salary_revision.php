...
return new class extends Migration
{
    ...
    {
        Schema::create('m_salary_revision', function (Blueprint $table) {
            $table->id();
            ...
            $table->tinyInteger('fixed_flg')->comment('定時・随時フラグ');
            $table->timestamps();
            $table->comment('標準報酬月額改定マスタ');
        });
    }
    ...
    {
        Schema::dropIfExists('m_salary_revision');
    }
};
